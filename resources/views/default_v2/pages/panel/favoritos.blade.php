                        ...
                        <div class="">
                            <h2 class="accordion-item accordion-header" id="{{ $all_inf['inf']->cod_sub }}-heading">
                                <button class="accordion-button" data-bs-toggle="collapse"
                                    data-bs-target="#{{ $all_inf['inf']->cod_sub }}-collapse" type="button"
                                    aria-expanded="true" aria-controls="{{ $all_inf['inf']->cod_sub }}-collapse">
                                    {{ $all_inf['inf']->name }}
                                </button>
                            </h2>

                            <div class="accordion-collapse collapse show" id="{{ $all_inf['inf']->cod_sub }}-collapse"
