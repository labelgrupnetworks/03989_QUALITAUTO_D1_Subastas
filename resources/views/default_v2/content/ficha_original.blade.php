...
<section class="container ficha-title">
	<div class="row">
		<div class="col-12">
			@php
...
<section class="ficha-content">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-8 ficha-image-container" style="position: relative">
                @php
				...
				<div class="favoritos d-sm-none">
					<a @class(['secondary-button', 'd-none' => $lote_actual->favorito]) id="add_fav" href="javascript:action_fav_modal('add')">
						{{ trans(\Config::get('app.theme').'-app.lot.add_to_fav') }}
					</a>
					<a @class(['secondary-button', 'd-none' => !$lote_actual->favorito]) id="del_fav" href="javascript:action_fav_modal('remove')">
                ...
                <div class="d-none d-sm-block">
					...
					<div class="img-global-content position-relative">
                    	...
                    	<div id="img_main" class="img_single">
                            ...
                            <img class="img-fluid" src="{{Tools::url_img('lote_large',$lote_actual->num_hces1,$lote_actual->lin_hces1)}}" alt="{{$lote_actual->titulo_hces1}}">
                            </a>
                        </div>
					...
					@if(Session::has('user') &&  !$retirado)
					<div class="favoritos">
						<a @class(['secondary-button', 'd-none' => $lote_actual->favorito]) href="javascript:action_fav_modal('add')">
							{{ trans(\Config::get('app.theme').'-app.lot.add_to_fav') }}
						</a>
						<a @class(['secondary-button', 'd-none' => !$lote_actual->favorito]) href="javascript:action_fav_modal('remove')">
							{{ trans(\Config::get('app.theme').'-app.lot.del_from_fav') }}
						</a>
					</div>
					@endif
    		...
    		<div class="col-12 col-sm-4 content-right-ficha d-flex flex-column">
				...
				@include('includes.ficha.header_time')
       			...
       			<div class="d-flex flex-column">
					...
					<div class="ficha-info-content h-100 d-flex flex-column justify-content-center">
...
<section class="container ficha-details">
	<div class="row">
		<div class="col-12 ficha-tipo-v">
...
<section class="container ficha-files">
	<div class="row">
		<div class="col-12">
...
<section class="container ficha-destacados">
	<div class="row">
		<div class="single">
			<div class="col-12 col-md-7"></div>

			<div class="col-12 lotes_destacados" id="lotes_recomendados-content">
					<div class="mas-pujados-title">
