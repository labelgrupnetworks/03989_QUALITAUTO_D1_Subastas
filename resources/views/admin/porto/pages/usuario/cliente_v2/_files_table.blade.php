<div class="col-xs-12 mb-3 mt-3">
	<div class="form-group mb-3">
		...
		<input id="store_file_route" type="hidden" value="{{ route('clientes.files.store', ['cod_cli' => $cliente->codcli])}}">
	</div>
			...
			<tbody id="bodyTableFile">
				...
				@foreach ($files as $file)
					<tr>
						...
						<td>
							<button type="button" class="btn btn-xs btn-danger" onclick="deleteFile('{{$file->unlink}}')">Eliminar</button>
						</td>
					</tr>
				@endforeach
			</tbody>
