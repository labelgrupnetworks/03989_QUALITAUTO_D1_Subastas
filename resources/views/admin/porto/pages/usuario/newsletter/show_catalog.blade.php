...
@section('content')
    ...
    <section role="main" class="content-body">
        ...
        <div class="row well header-well">
            <div class="col-xs-12">
                <h1 class="m-none">Newsletters - Catálogos</h1>
                <p class="text-right">
        ...
        <div class="row well">
            ...
            <div class="col-xs-12 table-responsive">
                <table id="clients_newsletter_catalog" class="table table-striped table-condensed" style="width:100%"
                    ...
                    <tbody>
                        ...
                        @forelse ($suscriptions as $suscription)
                            ...
                            <tr id="fila_{{ $suscription->cod_cli }}">
