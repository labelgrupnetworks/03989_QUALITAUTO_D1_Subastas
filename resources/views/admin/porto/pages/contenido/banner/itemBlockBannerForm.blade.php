...
@foreach(\Config::get("app.locales") as $lang => $textLang)
        <a onclick="change_lang('{{strtoupper($lang)}}');" class="btn btn-primary" id="{{strtoupper($lang)}}button" style="cursor:pointer;color:#FFF">{{$textLang}}</a>
	&nbsp;&nbsp;&nbsp;
...
@endforeach
	...
	<center><button id="btnGuardarItem" data-lang="formLenguaje{{ strtoupper($lang) }}" class="btn btn-success">Guardar</button></center>
