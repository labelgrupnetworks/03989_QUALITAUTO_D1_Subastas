...
<section role="main" class="content-body">
	...
	<div class="row well header-well d-flex align-items-center">
		...
		<div class="col-xs-6 text-right">
			...
			@if ($anterior)
			<a href="{{ route('subastas_concursales.lotes_concursales.edit', ['cod_sub' => $cod_sub, 'ref_asigl0' => $anterior,'menu' => 'subastas', 'render' => $render ] ) }}"
				class="btn btn-warning">{{ trans("admin-app.button.prev") }}</a>
			@endif
			@if ($siguiente)
			<a href="{{ route('subastas_concursales.lotes_concursales.edit', ['cod_sub' => $cod_sub, 'ref_asigl0' => $siguiente,'menu' => 'subastas', 'render' => $render]) }}"
