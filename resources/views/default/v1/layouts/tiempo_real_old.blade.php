...
<link rel="stylesheet" href="{{ URL::asset('/vendor/bootstrap/3.3.6/css/bootstrap.min.css') }}" />
				...
				<div class="language">
							...
							>
								...
								<option value="en"><?= trans($theme.'-app.head.language_en') ?></option>
                                                ...
                                                <?PHP /* BLOQUEO EL GOOGLE TRANSLATE

                                                                <div id="google_translate_element"></div>

                                                        <script type="text/javascript">
                                                                function googleTranslateElementInit() {
                                                                        new google.translate.TranslateElement({pageLanguage: 'es', includedLanguages: 'en,de,fr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
                                                                }
                                                        </script>
				...
				<div class="modal-wrapper">
					<div class="modal-text text-center">
						<p class="insert_msg">{{ trans($theme.'-app.sheet_tr.open_lot') }}</p>
                                                <p class="insert_msg <?= !empty(Config::get('app.deleteBids'))?'':'hidden'; ?>"><input type="checkbox" class="deleteBids"> {{ trans($theme.'-app.sheet_tr.open_lot_delete') }}</p>
