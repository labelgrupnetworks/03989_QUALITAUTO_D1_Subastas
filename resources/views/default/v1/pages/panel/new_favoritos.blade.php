												...
												@foreach ($all_inf['lotes'] as $inf_lot)
													<div class="user-accout-item-wrapper  col-xs-12 no-padding">
														<div class="d-flex">
															...
															@else
															class="other" @endif>
																		<?= empty($inf_lot->implic_hces1) ? '-' : \Tools::moneyFormat($inf_lot->implic_hces1) . ' ' . trans(\Config::get('app.theme') . '-app.subastas.euros') ?>
																	</div>
															...
															<div class="col-xs-12 col-sm-3 col-lg-2 account-item-border">
																<div class="user-account-item-price  d-flex align-items-center">
																	<div><a title="{{ trans(\Config::get('app.theme') . '-app.lot.del_from_fav') }}" class="d-block"
																			href="javascript:action_fav_lote_new('remove','{{ $inf_lot->ref_asigl0 }}','{{ $inf_lot->id_sub }}')">{{ trans(\Config::get('app.theme') . '-app.lot.del_from_fav') }}</a>
																	</div>
