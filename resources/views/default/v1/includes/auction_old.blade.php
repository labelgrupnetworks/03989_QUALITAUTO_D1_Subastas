                ...
                @if (!empty($files))
                    @foreach ($files as $file)
                        ...
                        <div class="row">
                            ...
                            @if ($file->type == 5)
                                <div class="col-xs-1 text-center"><i class="fa fa-map-marker" aria-hidden="true"
                    ...
                    <ul class="ul-format">
                        ...
                        @if ($pdf_cat)
                            <li class="col-md-12 col-xs-6 no-padding">
                                <a target="_blank" class="cat-pdf color-letter d-flex" href="{{ $pdf_cat }}"
                                    role="button">
                        ...
                        @if ($pdf_man)
                            <li class="col-md-12 col-xs-6 no-padding">
                                <a target="_blank" class="cat-pdf color-letter d-flex" href="{{ $pdf_man }}"
                                    role="button">
                                    <div class="text-center"><i class="fas fa-file-download"></i>
                                    </div>
                        ...
                        @if ($pdf_pre)
                            <li class="col-md-12 col-xs-6 no-padding">
                                <a target="_blank" class="cat-pdf color-letter d-flex" href="{{ $pdf_pre }}"
                                    role="button">
                                    <div class="text-center"><i class="fas fa-file-download"></i>
                                    </div>
                        ...
                        @if ($pdf_adj)
                            <li class="col-md-12 col-xs-6 no-padding">
                                <a target="_blank" class="cat-pdf color-letter d-flex" href="{{ $pdf_adj }}"
                                    role="button">
                                    <div class="text-center"><i class="fas fa-file-download"></i>
                                    </div>
