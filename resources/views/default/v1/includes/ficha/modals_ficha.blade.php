            ...
            <div   data-to="pujarLoteFicha" class="modal-sub-w"  >
                    <section class="panel">
                            <div class="panel-body">
                                    <div class="modal-wrapper">
                                            <div class=" text-center single_item_content">
												...
												<strong><span class="precio_orden"></span> {{ trans($theme.'-app.subastas.euros') }}</strong>
						...
						<p class="phonebid_js">{{trans($theme.'-app.lot.phonebid_text')}} <br></p>
                                                <p class="phonebid_js"><?=trans($theme.'-app.login_register.phone')?> 1: <input style="padding: 0 0 0 5px;" type="text" value="" name="phone1" id="phone1Bid_JS"></p>
					        <p class="phonebid_js"><?=trans($theme.'-app.login_register.phone')?> 2: <input style="padding: 0 0 0 5px;" type="text" value="" name="phone2" id="phone2Bid_JS"></p>
			...
			<section class="panel">
					<div class="panel-body">
							<div class="modal-wrapper">
									<div class=" text-center single_item_content_">
										<p class="class_h1">{{ trans($theme.'-app.lot.confirm_bid') }}</p><br/>
										<span for="bid" class='desc_auc'>{{ trans($theme.'-app.lot.you_are_bidding') }} </span> <strong><span class="imp_make_offer"></span> {{ trans($theme.'-app.subastas.euros') }}</strong><br/>
											</br>

					<button class="btn btn-primary modal-confirm btn-custom">{{ trans($theme.'-app.sheet_tr.confirm') }}</button>
					<button class="btn btn-default modal-dismiss">{{ trans($theme.'-app.sheet_tr.cancel') }}</button><div class='mb-10'></div>
											 <div class='mb-10'></div>
