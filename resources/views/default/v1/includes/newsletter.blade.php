    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                <div class="newsletter-tittle">{{ trans($theme . '-app.foot.newsletter_title') }}
                </div>
            ...
            <div
                ...
                <button id="newsletter-btn" type="submit"
                    class="button-principal button-newsletter">{{ trans($theme . '-app.foot.newsletter_button') }}</button>
            </div>
            <div
