    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 title-head-grid">
            <div class="col-xs-5 col-sm-3 col-md-3 col-lg-3">
                <h3 class="titlePage-custom">{{trans('web.lot_list.indice_auction')}}</h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9">
                <table class="table-custom">
                    <thead>
                        <tr>
                            <th class="first-column-orders btn-color">{{ trans('web.lot_list.name') }}</th>
                            <th class="second-column-orders btn-color">{{ trans('web.lot_list.from') }}</th>
                            <th class="third-column-orders btn-color">{{ trans('web.lot_list.to') }}</th>
                        </tr>
                    </thead>
                    <tbody>
