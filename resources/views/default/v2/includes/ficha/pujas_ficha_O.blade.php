<div class="ficha-pujas ficha-pujas-o" id="reload_inf_lot">
    ...
    <p @class([
        ...
        <span
            class="precio_minimo_alcanzado hidden">{{ trans(\Config::get('app.theme') . '-app.subastas.reached') }}</span>
        <span
            class="precio_minimo_no_alcanzado hidden">{{ trans(\Config::get('app.theme') . '-app.subastas.no_reached') }}</span>
    </p>
