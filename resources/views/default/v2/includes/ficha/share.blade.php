    ...
    <ul class="list-unstyled d-flex m-0">
        ...
        <li class="ms-3">
            <a class="lb-text-primary"
                ...
                title="{{ trans('web.lot.share_twitter') }}" target="_blank">
        ...
        <li class="ms-3">
            <a class="lb-text-primary"
                ...
                title="{{ trans('web.lot.share_email') }}" target="_blank">
                <svg class="bi" width="24" height="24" fill="currentColor">
