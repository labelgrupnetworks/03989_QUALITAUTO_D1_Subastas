    ...
    <div class="container">
        <div class="row flex-column-reverse flex-md-row">
            ...
            <div class="col-12 col-md-7 px-4 mb-5 mb-md-0 d-flex flex-column gap-4">
                <h2 class="h1 newsletter-tittle lb-text-primary">{{ trans('web.foot.newsletter_title') }}</h2>
                <h3 class="h2 newsletter-subtittle">{{ trans('web.foot.newsletter_description') }}</h3>
