...
<div class="row">
	<div class="col-xs-12">
		<button type="button" class="btn btn-color fav-address" cod="{{$address->codd_clid}}">{{ trans('web.user_panel.define_default') }}</button>

		<button type="button" class="btn btn-color delete-address" cod="{{$address->codd_clid}}">{{ trans('web.user_panel.delete') }}</button>
	</div>
</div>
@endif
...
<div class="row">
	<div class="col-xs-12">
		<button type="submit" class="btn btn-color" cod="">{{ trans('web.user_panel.save') }}</button>
	</div>
</div>
@endif
