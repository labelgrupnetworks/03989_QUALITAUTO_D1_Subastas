        ...
        <div class="row">
            ...
            <div class="col-lg-9">
				<section class="account-info mb-5">
					<h1>{{ trans("web.user_panel.datos_contacto") }}</h1>
					...
					<form method="post" class="frmLogin" id="frmUpdateUserInfoADV" data-toggle="validator">
						...
						<div class="row gy-1">
							...
							<div class="col-12">
								<button type="submit" class="btn btn-lb-primary">{{ trans("web.user_panel.save") }}</button>
							</div>
						</div>
					</form>
				</section>
				...
				<section class="account-user mb-5">
					<h1>{{ trans("web.login_register.cuenta") }}</h1>
					...
					<form method="post" class="frmLogin" id="frmUpdateUserPasswordADV" data-toggle="validator">
						...
						<div class="row gy-1">
							...
							<div class="col-md-4">
								<label class="form-label">
									{{ trans("web.user_panel.new_pass_repeat") }}
									<div class="input-group">
