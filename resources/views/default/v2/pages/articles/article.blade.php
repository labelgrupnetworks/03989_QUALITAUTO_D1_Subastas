...
<?php
	...
	if( !empty(\Config::get("app.uniqueArtCategory"))){
		...
		$bread[] = array("url" => route('articles-category',["category" => trans('web.links.'.\Config::get("app.uniqueArtCategory").'_category')]), "name" =>trans(\Config::get("app.theme")."-app.articles.articles") );
	}else{
