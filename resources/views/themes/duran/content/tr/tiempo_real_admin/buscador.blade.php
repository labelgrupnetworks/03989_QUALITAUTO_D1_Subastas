<div class="hidden started">
    <div>
        ...
        <div class="aside" id="loteAjax">
            <h2 class="full-left">{{ trans(\Config::get('app.theme').'-app.sheet_tr.lot') }} <span id="slote_title">
				{{		str_replace(array(".1",".2",".3", ".4", ".5"), array("-A", "-B", "-C", "-D", "-E"),  $data['subasta_info']->lote_siguiente->ref_asigl0)	}}</span></h2>
            ...
            <div class="row">
               ...
               <div class="row">
                ...
                <div class="col-lg-6">
					...
					<?php
						#en duran no puede ni comprar lote ni hacer orden por lo que comento el código
						/*
