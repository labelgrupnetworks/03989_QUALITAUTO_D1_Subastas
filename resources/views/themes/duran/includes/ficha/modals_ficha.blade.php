					...
					<div class="panel-body">
							<div class="modal-wrapper">
									<div class=" text-center single_item_content">
										<p class="class_h1"><?=trans($theme.'-app.lot.title_phone_bid')?> <span id="numLotPhoneBid"> </span></p>
										<br/>

										<br>
										{{ Session::get('user.name')}},	{{trans($theme.'-app.lot.phonebid_text')}} <br><br>

										<p><?=trans($theme.'-app.login_register.phone')?>: <input style="padding: 0 0 0 5px;" type="text" value="" name="phone1" id="phone1Bid_JS"></p>
										<p><?=trans($theme.'-app.login_register.mobile')?>: <input style="padding: 0 0 0 5px;" type="text" value="" name="phone2" id="phone2Bid_JS"></p>
										<?=trans($theme.'-app.global.coment')?>:
										<br/>
										<p><textarea style="padding: 5px;" id="commentsBid_JS" placeholder="{{trans($theme.'-app.lot.placeholder_phonebid_text')}}"  name="comments" cols="40" rows="10"></textarea></p>
										<br/>

										<br/>
											<button id="confirm_orden_telefonica" class="btn button_modal_confirm btn-custom"><?=trans($theme.'-app.lot.confirm')?> </button>
            ...
            <div   data-to="pujarLoteFicha" class="modal-sub-w"  >
                    <section class="panel">
                            <div class="panel-body">
                                    <div class="modal-wrapper">
                                            <div class=" text-center single_item_content">
												<p class="class_h1"><?=trans($theme.'-app.lot.confirm_bid')?></p>

												<br/>
                                                <span for="bid" class='desc_auc'>{{trans($theme.'-app.lot.bidding_for')}} </span> <strong><span class="precio_orden"></span> €</strong><br/>
													<br/>
													<p class="phonebid_js">{{trans($theme.'-app.lot.phonebid_text')}} <br><span id="phone_contact_js"> </span></p>
													<br/>
