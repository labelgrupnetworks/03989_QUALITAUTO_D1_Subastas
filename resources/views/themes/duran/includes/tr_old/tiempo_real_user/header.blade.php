<link rel="stylesheet" href="{{ URL::asset('/css/tiempo_real/tiempo_real.css') }}?a={{rand()}}" />
<link rel="stylesheet" href="{{ URL::asset('/themes/'. $theme.'/css/tiempo_real/tiempo_real.css') }}?a={{rand()}}" />
<header>
    <nav class="nav_tr">
        ...
        <div class="header_content @if(!Session::has('user')) {{"header_nologin"}} @endif">
            ...
            <div class="menu header_session">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ \Routing::slug('login') }}" class="btn button btn-register">{{ trans(\Config::get('app.theme').'-app.login_register.register') }}</a>
                    </li>
                    @else
