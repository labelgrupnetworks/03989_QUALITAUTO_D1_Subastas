        ...
        <div class="menu-principal">
            ...
            <ul class="menu-principal-content d-flex justify-content-left align-items-center">
                ...
                ?>
 				...
 				<li><a class="color-letter flex-display link-header justify-center align-items-center" href="/<?= \Config::get("app.locale") ?>/subasta/tienda-online_7500-001?order=orden_desc"><span>{{  trans($theme.'-app.foot.compra_ahora') }}</span></a></li>
				<li><a class="color-letter flex-display link-header justify-center align-items-center" href="{{ Routing::translateSeo('pagina').trans($theme.'-app.links.how_to_sell')  }}"><span>{{   mb_strtoupper ( trans($theme.'-app.foot.how_to_sell')  ) }}</span></a></li>
{{--
				<li><a class="color-letter flex-display link-header justify-center align-items-center" href="/{{\Config::get("app.locale")}}/info-subasta/7503-venta-privadas"><span>{{   mb_strtoupper ( trans($theme.'-app.foot.ventas_privadas')  ) }}</span></a></li>
--}}
				<li><a class="color-letter flex-display link-header justify-center align-items-center" href="{{ Routing::translateSeo('pagina').trans($theme.'-app.links.valorar_producto')  }}"><span>{{   mb_strtoupper ( trans($theme.'-app.foot.tasaciones')  ) }}</span></a></li>

				<li>
					<a class="color-letter d-flex link-header align-items-center hidden-xs">
					  <span>{{trans($theme.'-app.foot.descubre') }}</span>
					</a>
					  <div class="submenuDuran ">
							<div >
								<div class="categoryOption"> <a  href="https://blog.duran-subastas.com/" target="_blank">{{ trans($theme.'-app.foot.magazine')}}</a> </div>


								<div class="categoryOption"> <a  href="<?= route("artists") ?>">{{ trans($theme.'-app.artist.artists')}}</a> </div>

							</div>
					  </div>
				</li>
				{{--
				<li><a class="color-letter flex-display link-header justify-center align-items-center" href="https://www.durangallery.com"><span>{{   mb_strtoupper ( trans($theme.'-app.foot.galeria')  ) }}</span></a></li>
				--}}

				<li>
					<a class="color-letter d-flex link-header align-items-center ">
					  <span>{{trans($theme.'-app.foot.duran') }}</span>
					</a>
					  <div class="submenuDuran ">
							<div >
								<div class="categoryOption"> <a  href="<?= \Routing::translateSeo(trans($theme.'-app.links.contact')) ?>">{{ trans($theme.'-app.foot.contact')}}</a> </div>
								<div class="categoryOption"> <a  href="{{ Routing::translateSeo('pagina').trans($theme.'-app.links.about_us')  }}">{{ trans($theme.'-app.foot.nosotros') }}</a> </div>
                    ...
                    <div class="my-account color-letter-header">
                        <div class="row">
                            <div class="col-xs-3 text-center">
                                <img width="25px;" class="icono-customer" src="/themes/{{$theme}}/assets/img/user.png"  alt="{{(\Config::get( 'app.name' ))}}">
                            </div>
       ...
       <div class="menu-responsive hidden-lg">
            <div role="button" class="menu-text d-flex justify-content-center align-items-center color-letter ">
                <img class="icono-movil-menu" role="button" src="/themes/{{$theme}}/assets/img/menu-movil.png" alt="Movil">
            </div>
        </div>
    </nav>
</header>
