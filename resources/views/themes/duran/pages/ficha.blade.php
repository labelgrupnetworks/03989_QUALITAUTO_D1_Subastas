...
@php
$seo = new StdClass();
$seo->meta_title = $data['subasta_info']->lote_actual->descweb_hces1;
$seo->meta_description = $data['subasta_info']->lote_actual->descweb_hces1;
...
<?php
    ...
    if(!empty($lote_actual)){
		...
		elseif($lote_actual->tipo_sub=="V" || $lote_actual->tipo_sub=="E" ){
			$url_subasta.="?order=orden_desc";
		}


        $bread = array();
        $bread[] = array("url" => $url_subasta, "name" =>$lote_actual->des_sub  );
...
<div class="breadcrumb-total row">
    <div class="col-xs-12 col-sm-12 text-center color-letter bread-ficha">
