...
<div class="breadcrumb-total row">
    <div class="col-xs-12 col-sm-12 text-center color-letter">
        ...
        <div class="container">
		<?php /*	<h1 class="titlePage"> {{ trans($theme.'-app.home.free-valuations') }}</h1> */ ?>
            ...
            <div class="row">
                ...
                <form id="form-valoracion-adv" class="form">
				 ...
				 <div class="col-xs-12 info">
					...
					<?=  trans($theme.'-app.valoracion_gratuita.como_contactar')  ?>
					<?=  trans($theme.'-app.valoracion_gratuita.proceso')  ?>
                </div>
					@php
					/*

								<div class="col-xs-12 info">
									<?=  trans($theme.'-app.valoracion_gratuita.FAQ1')  ?>
									<?=  trans($theme.'-app.valoracion_gratuita.FAQ2')  ?>
									<?=  trans($theme.'-app.valoracion_gratuita.FAQ3')  ?>
								</div>
