...
@section('content')
<link rel="stylesheet" href="{{ URL::asset('/css/tiempo_real/tiempo_real_proyector.css') }}?a={{rand()}}" />
<link rel="stylesheet" href="{{ URL::asset('/themes/'.$theme.'/css/tiempo_real/tiempo_real_proyector.css') }}?a={{rand()}}" />
