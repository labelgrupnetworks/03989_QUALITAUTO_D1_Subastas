            ...
            <div class="col-lg-8 col-md-8 ">
                <div class="fondo1 aside" style="margin-top:0;">
					...
					<div class="col-lg-6" style="border-left:0;">
						...
						<span id="lote_actual_main" class="hidden"
								style="display:block">{{ trans($theme.'-app.sheet_tr.lot') }} <strong><span
										id="info_lot_actual">
						...
						<div class="scrollable" >
							...
							<div class="autor_tr" > <strong>	{{ trans($theme.'-app.sheet_tr.author') }}:</strong> <span id="autor_JS">{{ $data['subasta_info']->lote_actual->autor }} </span></div>
                            ...
                            */ ?>
							...
							<div id="precioReserva" class="precioReserve salida text-center">
                                <p>
                                    <strong>{{ trans($theme.'-app.sheet_tr.reserve_price') }}:</strong>
									@if($data['js_item']['subasta']['currency']->symbol == "$")
							...
							@if (\Config::get('app.tr_cost_price'))
								<div id="precioCoste" class="salida text-center">
									<p>
										<strong>{{ trans($theme.'-app.sheet_tr.cost_price') }}:</strong>
										@if($data['js_item']['subasta']['currency']->symbol == "$")
                    ...
                    <h2>{{ trans($theme.'-app.sheet_tr.orders') }}</h2>
                        ...
                        <?php foreach ($data['subasta_info']->lote_actual->ordenes as $orden) : ?>
                                ...
                                <div class="ol_model">
                                    <div class="col-lg-6 tipoOrden">
                                        ...
                                        <p data-type="X" @if ($orden->tipop_orlic != 'X')class="hidden" @endif><i class="fa fa-phone" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.bid-telf') }} Web</p>
                        ...
                        <div class="ol_model hidden" id="type_bid_model_order">
                            <div class="col-lg-6 tipoOrden">
                                ...
                                <p data-type="S" class="hidden"><i class="fa fa-hand-paper-o" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.bid-sala') }}</p>
                                <p data-type="X" class="hidden"><i class="fa fa-phone" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.bid-telf') }} Web</p>
                                <p data-type="T" class="hidden"><i class="fa fa-phone" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.bid-telf') }}</p>
                                <p data-type="E" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.books_bid') }}</p>
                                <p data-type="P" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.books_bid') }}</p>
								<p data-type="O" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans($theme.'-app.sheet_tr.books_bid') }}</p>
       ...
       <div id="controles_gestor_box">
           <div class="gestor_buttons">
               <p>{{ trans($theme.'-app.sheet_tr.user_conectet') }} <span id="users_conectet"></span></p>
                ...
                <div>
                    <button id="confirm_automatic_auction" style="background: #337ab7;    display: inline-block;    width: 170px;" class="btn" type="button">{{ trans($theme.'-app.sheet_tr.automatic_auction') }}</button>
