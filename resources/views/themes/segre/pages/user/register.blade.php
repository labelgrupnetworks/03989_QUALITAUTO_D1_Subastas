						...
						<div class="well">
							...
							<div class="datos_condiciones">
								...
								<div class="checkbox-container condiciones col-xs-12">
									...
									<label for="bool__1__condiciones">{!! trans(\Config::get('app.theme') . '-app.login_register.read_conditions') !!} (<a href="<?php echo Routing::translateSeo('pagina') . trans(\Config::get('app.theme') . '-app.links.term_condition'); ?>"
