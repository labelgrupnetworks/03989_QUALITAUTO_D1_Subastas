...
<div class="zone-share-social col-xs-12 no-padding d-flex justify-content-space-between">
        ...
        <li>
            <a class=" d-flex align-items-center justify-content-center color-letter" title="{{ trans(\Config::get('app.theme').'-app.lot.share_twitter') }}" href="http://twitter.com/share?text=<?= $titulo.' '.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']?>&url=<?=$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>">
