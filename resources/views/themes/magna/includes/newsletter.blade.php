<section class="newsletter-section newsletter-js">
        ...
        <div class="newsletter-grid">
            ...
            <div class="newsletter_input position-relative">
                <div class="form-floating">
                    <input class="form-control newsletter-input newsletter-input-email-js" id="newsletter-input" name="email" type="email"
            ...
            <button class="btn btn-outline-lb-primary rounded-5 newsletter-btn-js" type="button">
