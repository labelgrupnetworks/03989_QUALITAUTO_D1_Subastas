																	...
																	<div class="col-xs-12 col-sm-9 no-padding">
																		...
																		<div class="user-account-item-title">
																			...
																			<p> {{ trans(\Config::get('app.theme') . '-app.lot.lot-price') }}:
																				...
																				{{ $inf_lot->formatted_impsalhces_asigl0 }} </p>
																		</div>
															...
															<div class="col-xs-12 col-sm-2  account-item-border ">
																<div class="user-account-item-date d-flex align-items-center justify-content-center">
																	...
																	@if (!empty($inf_lot->implic_hces1))
																		{{ \Tools::moneyFormat($inf_lot->implic_hces1, trans(\Config::get('app.theme') . '-app.subastas.euros'), 0, 'F') }}
																	@else
																		-
																	@endif
																</div>
																	...
																	<div style="text-align: center;"
																		@if (
																			($inf_lot->cod_licit == $inf_lot->licit_winner_bid &&
																				...
																				@else
																					class="other" @endif>
																		{{ trans(\Config::get('app.theme') . '-app.subastas.euros') }} {{ $inf_lot->formatted_imp }}
																		<br />
