				...
				<form method="post" id="registerForm" action="javascript:submit_register_form()">
					...
					<div class="well">
						...
						<br>
							...
							<div class="col-xs-12 credit_card datos_left">
							...
							<div class="form-row card-expired-wrapper datos_right">
								...
								<div class="form-group col-xs-3 col-sm-2" style="padding: 0">
								...
								<div class="form-group col-xs-1 col-sm-1 card-expired-separator text-center" style="padding: 0">
                    ...
                    @if(!config('app.delivery_address', 0))
					...
					<div class="col-xs-12 text-center">
						<button type="submit" class="submitButton button-principal" style="margin: 0 20px">
							{{ trans(\Config::get('app.theme').'-app.login_register.register') }}
						</button>

						<a href="https://www.thedreamauctions.com/">
							<button type="button" class="button-principal">
