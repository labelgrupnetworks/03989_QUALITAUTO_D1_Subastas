            ...
            <div class="data-container">
					...
					<div class="data-price text-center">
						@if( !$retirado && !$devuelto)
							...
							@elseif (!$hay_pujas)
							<p>
								<span class="salida-title">{{ trans(\Config::get('app.theme').'-app.lot.estimate') }}</span>
								<span class="salida-price">{{ trans(\Config::get('app.theme').'-app.subastas.euros') }} {{ $estimacion . '-' . $estimacionAlta }}</span>
							</p>
							@endif
