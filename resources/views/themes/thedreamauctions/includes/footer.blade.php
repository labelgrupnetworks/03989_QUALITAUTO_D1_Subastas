					...
					<div class="col-xs-12 col-sm-4 text-center">
						...
						<ul class="ul-format footer-ul">
							<li><a class="footer-link"
									...
									href="https://www.thedreamauctions.com/quienes-somos/">{{ trans($theme.'-app.foot.about_us') }}</a>
							</li>
							<li>
								<a class="footer-link" title="{{ trans($theme.'-app.foot.contact')}}"
								href="https://www.thedreamauctions.com/contacto/"><span>{{ trans($theme.'-app.foot.contact')}}</span></a>
							</li>
					...
					<div class="col-xs-12 col-sm-7 enterprise text-justify">
						<div class="row">
							<div class="col-xs-12 col-sm-6 no-padding">
								...
								{{ $empresa->dir_emp ?? ''}}<br>
								{{ $empresa->cp_emp ?? ''}} {{ $empresa->pob_emp ?? ''}}<br>
							</div>
