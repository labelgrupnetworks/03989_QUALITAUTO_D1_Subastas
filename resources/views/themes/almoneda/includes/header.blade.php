    ...
    <nav class="menu-header">
        ...
        <div class="logo-header">
            <a title="{{ \Config::get('app.name') }}" href="/{{ $lang }}">
                ...
                <p>Entidad Especializada<br> en Subastas Concursales</p>
            </a>
        </div>
        <div class="menu-principal">
            ...
            <ul class="menu-principal-content d-flex  align-items-center">
                ...
                <li>
                    <a class="color-letter flex-display link-header justify-center align-items-center"
                        title="{{ trans($theme . '-app.foot.localizacion') }}"
                        href="{{ \Routing::translateSeo('pagina') . trans($theme . '-app.links.localizacion') }}"><span>{{ trans($theme . '-app.foot.localizacion') }}</span></a>
                </li>
