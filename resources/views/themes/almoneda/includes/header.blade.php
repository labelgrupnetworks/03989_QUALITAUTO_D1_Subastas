        ...
        <div class="menu-principal">
            ...
            <ul class="menu-principal-content d-flex  align-items-center">
                ...
                {{-- @if($global['subastas']->has('S') && $global['subastas']['S']->has('V'))
                    <li>
						<a class="color-letter flex-display link-header justify-center align-items-center" href="{{ \Routing::translateSeo('venta-directa') }}"><span>{{ trans($theme.'-app.foot.direct_sale')}}</span></a>
					</li>
                @endif --}}
				{{-- Subastas historicas --}}
...
{{-- <li>
	<a class="footer-link"
		...
		href="<¿php echo Routing::translateSeo('pagina').trans($theme.'-app.links.term_condition')?>">{{ trans($theme.'-app.foot.term_condition') }}</a>
				...
				{{-- Quienes Somos --}}
				<li>
                    <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans($theme.'-app.foot.about-us') }}" href="{{ \Routing::translateSeo('pagina').trans($theme.'-app.links.about_us') }}"><span>{{ trans($theme.'-app.foot.about_us')}}</span></a>
                </li>
				{{-- Servicios --}}
                {{-- <li>
                    <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans($theme.'-app.foot.servicios') }}" href="{{ \Routing::translateSeo('pagina').trans($theme.'-app.links.servicios') }}"><span>{{ trans($theme.'-app.foot.servicios')}}</span></a>
                </li> --}}
				{{-- Como Trabajamos --}}
				{{-- <li>
                    <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans($theme.'-app.foot.como_trabajamos') }}" href="{{ \Routing::translateSeo('pagina').trans($theme.'-app.links.como_trabajamos') }}"><span>{{ trans($theme.'-app.foot.como_trabajamos')}}</span></a>
                </li> --}}
				{{-- Ventajas --}}
				{{-- <li>
                    <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans($theme.'-app.foot.ventajas') }}" href="{{ \Routing::translateSeo('pagina').trans($theme.'-app.links.ventajas') }}"><span>{{ trans($theme.'-app.foot.ventajas')}}</span></a>
                </li> --}}
				{{-- Localización --}}
				<li>
                    <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans($theme.'-app.foot.localizacion') }}" href="{{ \Routing::translateSeo('pagina').trans($theme.'-app.links.localizacion') }}"><span>{{ trans($theme.'-app.foot.localizacion')}}</span></a>
                </li>
				{{-- Contacto --}}
                <li>
