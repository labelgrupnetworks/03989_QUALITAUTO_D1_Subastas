        ...
        <div class="row">
           ...
           ?>
                ...
                <div class="col-xs-12 no-padding favoritos visible-xs hidden-sm hidden-md hidden-ls">
                    <a  class="secondary-button  <?= $lote_actual->favorito ? 'hidden' : '' ?>" id="add_fav_responsive" href="javascript:action_fav_modal('add')">
                        {{ trans(\Config::get('app.theme').'-app.lot.add_to_fav') }}
                    </a>
                    <a class="secondary-button  <?= $lote_actual->favorito ? '' : 'hidden' ?>" id="del_fav_responsive" href="javascript:action_fav_modal('remove')">
                ...
                <div class="col-xs-12 no-padding hidden-xs">
                    ...
                    <div class="img-global-content position-relative">
						...
						@if(Session::has('user') &&  !$retirado)
							<a class="btn btns_fav <?= $lote_actual->favorito ? 'hidden':'' ?>" id="add_fav" href="javascript:action_fav_modal('add')">
								<i class="fa fa-heart-o" aria-hidden="true"></i>
							</a>
							<a class="btn btns_fav <?= $lote_actual->favorito ? '' : 'hidden' ?>" id="del_fav" href="javascript:action_fav_modal('remove')">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="col-xs-12 no-padding desc-lot-title">
				<p class="desc-lot-profile-title">{{ trans(\Config::get('app.theme').'-app.lot.documents') }}</p>
			</div>
			<div>
				<p class="col-xs-12 no-padding desc-lot-profile-content">
					<ul>
...
<div class="container">
    ...
    <div class="col-xs-12 no-padding ficha-tipo-v desc-margin">
