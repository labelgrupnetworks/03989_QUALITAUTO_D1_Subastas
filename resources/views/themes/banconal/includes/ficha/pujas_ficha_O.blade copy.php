    ...
    <div class="col-xs-12 no-padding info-ficha-buy-info-price d-flex">
            ...
            <div class="pre">
				@if ($lote_actual->ocultarps_asigl0 != 'S')
					...
					<p class="pre-price importePuja">{{$lote_actual->formatted_impsalhces_asigl0}} {{ trans(\Config::get('app.theme').'-app.subastas.euros') }}
					@if(\Config::get("app.exchange"))
			...
			<div class="pre d-flex  ">
				<div  id="text_actual_no_bid" class="price-title-principal pre col-xs-12  no-padding <?=  count($lote_actual->pujas) >0? 'hidden':'' ?>">
				...
				<div class="col-xs-12  no-padding">
					...
					@endif
					<strong class="importePuja"><span class="siguiente_puja"> </span> {{ trans(\Config::get('app.theme').'-app.subastas.euros') }}
						@if(\Config::get("app.exchange"))
