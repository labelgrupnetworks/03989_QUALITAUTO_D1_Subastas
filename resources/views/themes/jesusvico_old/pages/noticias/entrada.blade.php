...
<section class="article-body mt-2">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8 col-sm-offset-2 col-xs-12">
				<p class="entrada-relacionada-title">{{ trans(\Config::get('app.theme').'-app.blog.author') }}: {{ $data['news']->author_web_blog ?? '' }}</p>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-xs-12">
				...
				<div class="entradas-relacionadas-lista">
					...
					<?php
                                ...
                                ?>
					<div class="col-md-4 entrada-relacionada-item col-xs-6 d-flex flex-direction-column" style="height: 360px;">
						<div class="entrada-relacionada-title">
							{{ $rel_link->titulo_web_blog_lang }}
						</div>
						<div class="entrada-relacionada-author">
							@if(!empty($rel_link->author_web_blog))
							{{ trans(\Config::get('app.theme').'-app.blog.author') }}: {{ $rel_link->author_web_blog }}
							@endif
						</div>
						<div class="img-related-post d-flex" style="flex:1;">
							<img class="img-responsive align-self-center" src="{{ $rel_link->img_web_blog }}">
						</div>
						<div class="button-post d-flex" style="margin: 5px 0;">
							<a class="align-self-end" href="{{ $url }}"
