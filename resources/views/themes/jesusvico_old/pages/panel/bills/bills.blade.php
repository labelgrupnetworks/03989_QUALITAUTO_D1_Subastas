<tr class="factura" data-anum="{{$anum}}" data-num="{{$num}}"  data-efec="@if(!empty($efec)){{$efec}}@endif">

	<td class="factura_check" style="position: relative;">
	...
	<td>
		...
		@if(!empty($info_factura["T"] [$anum][$num]) && !empty($info_factura["T"] [$anum][$num][0]->des_dvc2t))
	...
	<td class="hidden-xs hidden-sm">{{\Tools::moneyFormat($precio_total ,false,2)}} €</td>
	<td><strong><span>{{\Tools::moneyFormat($imp,false,2)}}</span><span> €</span></strong></td>
</tr>
