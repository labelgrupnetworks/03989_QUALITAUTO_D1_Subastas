<div class="ficha-time d-flex flex-wrap col-xs-12 no-padding justify-content-space-between align-items-center">

        <div class="info_single_title info-type-auction-title no-padding d-flex justify-content-space-between">

			<div class="info-type-auction" style="display: none">
                 @if($subasta_online)
