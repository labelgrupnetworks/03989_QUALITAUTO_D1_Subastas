...
<div id="loginResponsive">
	<div class="contentLogin">
		...
		<form id="accerder-user-form-responsive">
			...
			<div class="form-group">
				<input maxlength="20" name="password" type="password" class="form-control" placeholder="{{ trans($theme.'-app.login_register.contraseña') }}">
			</div>
	...
	<section class="panel">
		<div class="panel-body">
			<div class="modal-wrapper text-center">
				<h1>{{ trans("$theme-app.home.alert_comision_title") }}</h1>
				<h4 style="margin: 20px 0">{{ trans("$theme-app.home.alert_comision_subtitle") }}</h4>
