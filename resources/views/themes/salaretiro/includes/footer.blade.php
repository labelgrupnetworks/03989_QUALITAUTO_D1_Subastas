        ...
        <div class="row">
                <div class="col-xs-12 col-sm-3">
                        <div class="module_footer text-left">
                                 ...
                                 ?>
                                <img height="60" src="/themes/{{$theme}}/assets/img/logo.png" alt="{{ trans($theme.'-app.home.name') }}">
                                <address>
                                         ...
                                         <strong><br><?= trans($theme.'-app.foot.horario') ?></strong>
                ...
                <div class="col-xs-12 col-sm-3">
					...
					<li><a title="{{ trans($theme.'-app.foot.aviso') }}" href="<?php echo Routing::translateSeo('pagina').trans($theme.'-app.links.aviso')?>">{{ trans($theme.'-app.foot.aviso') }}</a></li>
                                </ul>
                        </div>
                </div>
                <div class="col-xs-12 col-sm-3">
                        <div class="module_footer">
                                ...
                                <ul class="links">
										...
										<?php /* <li><a href="{{ \Routing::translateSeo('subastas-historicas') }}">{{ trans($theme.'-app.foot.historico')}}</a></li>
                ...
                <div class="col-xs-12 col-sm-3">
                        <div class="module_footer">
                                ...
                                <ul class="links">
                                    ...
                                    */?>
                                    <li><a title="{{ trans($theme.'-app.foot.custody_of_objects') }}" href="<?php echo Routing::translateSeo('pagina').trans($theme.'-app.links.custodia-de-objetos')?>">{{ trans($theme.'-app.foot.custody_of_objects') }}</a></li>
                                    <li><a title="{{ trans($theme.'-app.foot.advising') }}" href="<?php echo Routing::translateSeo('pagina').trans($theme.'-app.links.asesoramiento')?>">{{ trans($theme.'-app.foot.advising') }}</a></li>
                                    <li><a title="{{ trans($theme.'-app.links.our_guarantee') }}" href="<?php echo Routing::translateSeo('pagina').trans($theme.'-app.links.our_guarantee')?>">{{ trans($theme.'-app.head.our_guarantee') }}</a></li>
