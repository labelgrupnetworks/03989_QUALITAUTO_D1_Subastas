                            ...
                            @foreach ($all_adj as $key_sub => $all_inf)
                                ...
                                <a aria-expanded="true" data-toggle="collapse" href="#{{ $all_inf['inf']->cod_sub }}">
                                    <div class="panel-heading"
                                        style="position:relative; background: lightgrey;color: #101010">
                                        ...
                                        <table class="table table-hover" style="min-width: 650px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-weight: 100; color: grey;">
                                                        {{ trans(\Config::get('app.theme') . '-app.user_panel.name') }}
                                                    </th>
                                                    <th style="font-weight: 100; color: grey;">
                                                        {{ trans(\Config::get('app.theme') . '-app.user_panel.price') }}
                                                    </th>
                                                    <th style="font-weight: 100; color: grey;">
                                                        {{ trans(\Config::get('app.theme') . '-app.user_panel.price_comision') }}
                                                    </th>
                                                    <th style="font-weight: 100; color: grey;">
                                            ...
                                            @foreach ($all_inf['lotes'] as $inf_lot)
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th class="">
                                                            @if ($all_inf['inf']->compraweb_sub == 'S' && $inf_lot->fac_csub == 'N')
                                                        ...
                                                        <th>
                                                            <div class="img-dat img-data-customs flex valign" role="button"
                                                                id="">
                                        ...
                                        @if ($all_inf['inf']->compraweb_sub == 'S' && !empty(Config::get('app.merchantIdUP2')))
                                            <div class="adj d-flex justify-content-space-between">
                                                <div class="d-flex align-items-center ">
                                                    <span
                                                        style="font-size: 18px;">{{ trans(\Config::get('app.theme') . '-app.user_panel.total_price') }}
                                                    </span>
                                                    <div class="titlecat" style="font-size: 24px; margin-left: 10px">
                                                ...
                                                <div class="adj-inline">
													@if (\Config::get("app.urlToPackengers"))
														<a class="packengers-button-adjudicaciones" href="{{$urlCompletePackengers}}" target="_blank">
															...
															{{ trans("$theme-app.lot.packengers-adjudicaciones") }}
														</a>
													@endif
                                                    <button style="" type="button" class="submit_carrito btn btn-step-reg2"
