                    	...
                    	<div class="inputs-custom-group d-flex justify-content-space-between flex-wrap">
							...
							@else
								<div class="form-group {{-- input-group --}} name_client col-xs-12 col-sm-4">
									...
									<input type="text" class="form-control" name="usuario" placeholder="{{ trans($theme.'-app.user_panel.name') }}" required value="<?= $name[1] ?>">
							...
							<div class="form-group {{-- input-group --}} col-xs-12 col-sm-4 col-md-5">
								...
								<input name="provincia" class="form-control" placeholder="{{ trans($theme.'-app.login_register.provincia') }}" maxlength="30" type="text" value="{{$data['user']->pro_cli}}"/>
							...
							@if (\Config::get('app.userPanelCIFandCC'))
								<div class="form-group {{-- input-group --}} col-xs-12 col-md-8">
									...
									<div class="{{-- form-group-custom --}} form-group {{-- col-xs-12 --}}">
										<label>{{ trans($theme . '-app.login_register.credit_card') }}</label>
									...
									<div class="form-group {{-- input-group --}} col-xs-12 col-md-4">
										<div class="{{-- form-group-custom --}} form-group card-expired-wrapper">
											...
											<div class="form-group col-xs-12" style="margin: 0; padding: 0">
												<label
													for="">{{ trans($theme . '-app.login_register.expiration_date') }}</label>
											</div>
											<div class="row">
				...
				<div class="panel-body">
					<div class="modal-wrapper">
						<div class=" text-center single_item_content_">
							<p>{{ trans($theme.'-app.user_panel.delete_address') }}</p>
							<br>
