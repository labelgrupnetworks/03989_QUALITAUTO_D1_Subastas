                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="col-xs-12 col-md-12 pull-right">
                                                ...
                                                <div class="form-group input-group name_client">
                                                    ...
                                                    <input class="form-control" id="nombre" name="usuario" placeholder="{{ trans(\Config::get('app.theme').'-app.login_register.nombre_apellido') }}" type="text" value="{!! $nombre1 !!} {!! $nombre2 !!}">
                                                </div>
                                                ...
                                                <div class="form-group input-group">
                                                    <label for="telefono">{{ trans(\Config::get('app.theme').'-app.login_register.mobile') }}</label>
                                                    <input
                                                        name="mobile"
                                                        class="form-control"
    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2" style="border: 1px solid #ccc; margin-bottom: 10px; padding-bottom:20px;">
        ...
        <div class="col-xs-12 col-sm-12 col-sm-offset-0">
            <div class="form-group form-group-custom">
                <label for="email">{{ trans(\Config::get('app.theme').'-app.login_register.email') }}</label><label id="erroremail" class="hidden text-danger"></label>
                <input
                    class="form-control"
                    id="email"
        ...
        <div class="col-xs-12">
            <div class="checkbox">
              ...
              <div class="checkbox" style='margin-left: 40px;'>
               ...
               <label for="i-want-news">{{trans(\Config::get('app.theme').'-app.home.jewelry')}}</label>
              </div>
           <div class="checkbox"  style='margin-left: 40px;'>
                <input class="newsletter form-control" name="families[]" value="2" checked="" type="checkbox">
               <label for="i-want-news">{{ trans(\Config::get('app.theme').'-app.home.art') }}</label>
              </div>
            <div class="checkbox form-group">
                ...
                <label for="recibir-newletter">
                    ...
                    <div class="input-button-register">
                        ...
                        <button type="submit" class="btn btn-registro-salaretiro">{{ trans(\Config::get('app.theme').'-app.login_register.finalizar') }}</button>
                    </div>
                </div>
