        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12">
                <div class="crear">
                    <div class="tit_page">
                        <h1 class="step">
                            {{ trans($theme.'-app.login_register.crear_cuenta') }}
                        </h1>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="item-contact-data col-md-8 col-md-offset-2" style="border: 1px solid #ccc; margin-bottom: 10px; padding-bottom:20px;">
                                <div class="tit">{{ trans($theme.'-app.login_register.personal_information') }}</div>
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="input-group pull-right">
                                                <div class="form-group input-gener">
                                                    ...
                                                    <label class="input-check-custom" for="inlineRadio1">{{ trans($theme.'-app.login_register.hombre') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="input-group">
                                                <div class="form-group input-gener">
                                                    ...
                                                    <label class="input-check-custom" for="inlineRadio2">{{ trans($theme.'-app.login_register.mujer') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                <div class="row">
                                    <div class="col-xs-12 data-contact-container">
                                        <div class="col-xs-12 col-md-6">
                                            <div class="col-xs-12 col-md-12 pull-right">
                                                <div class="input-group date" data-provide="datepicker">
                                                    <label for="nombre">{{ trans($theme.'-app.user_panel.date_birthday') }}</label>
                                                ...
                                                <div class="form-group input-group name_client">
                                                    ...
                                                    <input class="form-control" id="nombre" name="usuario" placeholder="{{ trans($theme.'-app.login_register.nombre_apellido') }}" type="text" value="{!! $nombre1 !!} {!! $nombre2 !!}">
                                                </div>
                                                <div class="form-group input-group hidden rsoc_cli">
                                                    <label for="">{{ trans($theme.'-app.login_register.company') }}</label>
                                                    <input class="form-control" name="rsoc_cli" placeholder="{{ trans($theme.'-app.login_register.company') }}" type="text" value="{!! $nombre1 !!}">
                                                </div>
                                                <div class="form-group input-group hidden rsoc_cli">
                                                    <label for="">{{ trans($theme.'-app.login_register.contact') }}</label>
                                                    <input class="form-control" name="contact" placeholder="{{ trans($theme.'-app.login_register.contact') }}" type="text" value="{!! $nom_cli !!}">
                                                </div>
                                                ...
                                                <div class="form-group input-group">
                                                    <label for="telefono">{{ trans($theme.'-app.login_register.mobile') }}</label>
                                                    <input
                                                        name="mobile"
                                                        class="form-control"
                                        ...
                                        <div  class="form-group input-group">
                                            <label for="nif" class="dni_txt">{{ trans($theme.'-app.login_register.dni') }}</label>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-offset-2" style="border: 1px solid #ccc; margin-bottom: 10px; padding-bottom:20px;">
                    <div class="col-xs-12 ">
                        <div class="sub_page">
                            <div class="tit">{{ trans($theme.'-app.login_register.title_direccion_envio') }}</div>
                        </div>
    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2" style="border: 1px solid #ccc; margin-bottom: 10px; padding-bottom:20px;">
        ...
        <div class="col-xs-12 col-sm-12 col-sm-offset-0">
            <div class="form-group form-group-custom">
                <label for="email">{{ trans($theme.'-app.login_register.email') }}</label><label id="erroremail" class="hidden text-danger"></label>
                <input
                    class="form-control"
                    id="email"
        ...
        <div class="col-xs-12">
            <div class="checkbox">
              ...
              <div class="checkbox" style='margin-left: 40px;'>
                <input class="newsletter form-control" name="families[]" value="1" checked="" type="checkbox">
               <label for="i-want-news">{{trans($theme.'-app.home.jewelry')}}</label>
              </div>
           <div class="checkbox"  style='margin-left: 40px;'>
                <input class="newsletter form-control" name="families[]" value="2" checked="" type="checkbox">
               <label for="i-want-news">{{ trans($theme.'-app.home.art') }}</label>
              </div>
            <div class="checkbox form-group">
                ...
                <label for="recibir-newletter">
                    ...
                    <div class="input-button-register">
                        ...
                        <button type="submit" class="btn btn-registro-salaretiro">{{ trans($theme.'-app.login_register.finalizar') }}</button>
                    </div>
                </div>
