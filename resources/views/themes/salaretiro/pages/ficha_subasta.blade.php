...
@section('content') 
    <?php
        if($data['auction']->subc_sub == 'H' && $data['auction']->tipo_sub == 'W'){
            $url = \Routing::translateSeo('subastas-historicas-presenciales');
        }elseif($data['auction']->subc_sub == 'H' && $data['auction']->tipo_sub == 'O'){
            $url = \Routing::translateSeo('subastas-historicas-online');
