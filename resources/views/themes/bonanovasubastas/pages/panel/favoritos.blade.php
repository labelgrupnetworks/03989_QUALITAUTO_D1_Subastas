													...
													<div class="user-accout-item-wrapper col-xs-12 no-padding {{ $inf_lot->ref_asigl0 }}-{{ $inf_lot->cod_sub }}">
														<div class="d-flex d-block-sm">
															...
															class="other" @endif>
																		...
																		@endphp
																		<?= $conditionForSeePrice ? '-' : $inf_lot->pujas[0]->formatted_imp_asigl1 . ' ' . trans($theme . '-app.subastas.euros') ?>
																	</div>
																</div>
															</div>
												...
												<tbody>
													@foreach ($all_inf['lotes'] as $inf_lot)
														...
														<tr class='{{ $inf_lot->ref_asigl0 }}-{{ $inf_lot->cod_sub }}'>
															...
															<td>
																<?= empty($inf_lot->pujas->formatted_imp_asigl1) ? '-' : $inf_lot->pujas->formatted_imp_asigl1 . ' ' . trans($theme . '-app.subastas.euros') ?>
															</td>
