                                    ...
                                    <div class="col_reg_form"></div>
                                        <div class="row">
                                            <div class="">
                                                ...
                                                @else
                                                    <div class="form-group-custom form-group all-width">
													...
													<div class="form-group-custom form-group hidden">
                                                        <label for="nombre">{{ trans(\Config::get('app.theme').'-app.login_register.apellidos') }}</label>
                                                        <input type="text" class="form-control" name="last_name" placeholder="{{ trans(\Config::get('app.theme').'-app.login_register.apellidos') }}" value="<?= $name[0] ?>">
