        ...
        <div class="col-xs-12" style="margin-top: 20px;">
            <div class="tabs">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        <li role="pagar"  ><a href="{{ \Routing::slug('user/panel/pending_bills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.still_paid') }}</a></li>
                        <li role="pagadas"  class="active"><a href="{{ \Routing::slug('user/panel/myBills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.bills') }}</a></li>
                    </ul>
                </div>
        </div>
    </div>
...
<section class="pendientes_pago mb-4">
