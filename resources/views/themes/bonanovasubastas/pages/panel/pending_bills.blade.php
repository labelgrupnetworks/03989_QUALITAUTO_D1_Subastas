        ...
        <div class="col-xs-12" style="margin-top: 20px;">
            <div class="tabs">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li role="pagadas"  ><a href="{{ \Routing::slug('user/panel/myBills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.bills') }}</a></li>
                    </ul>
                </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 productos">
                    ...
                    @foreach($data['pending'] as $key_bill => $pendiente)
                     <div class="factura d-flex col-md-6" data-anum="{{$pendiente->anum_pcob}}" >
                ...
                <div class="col-md-12 text-right ">
                    <div class="facturacion_info_data col-xs-12">
