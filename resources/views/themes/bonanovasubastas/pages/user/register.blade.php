	...
	<div class="container register pb-5">
		<div class="row d-flex align-items-center justify-content-center">
			<div class="col-xs-12 general-container">
				<br>
				<div class="tit_page">
					<h1 class="step">{{ trans(\Config::get('app.theme').'-app.login_register.crear_cuenta') }}</h1>
				...
				<form method="post" id="registerForm" action="javascript:submit_register_form()">
					...
					<div class="clearfix"></div>
                                ...
                                <form id="formToSubalia" method="post" action="https://auctions-subalia-eng.labelgrup.com/registerclicli">
                                    @else
                                    <form id="formToSubalia" method="post" action="https://auctions-subalia.labelgrup.com/registerclicli">
                                        @endif
