                ...
                <?=  trans(\Config::get('app.theme').'-app.valoracion_gratuita.desc_assessment')  ?>
                 <form class="form" id="form-valoracion-adv">
                   ...
                   <div clas="row" >
                       <div class="col-md-12">
                           <br>
                            <button type="submit" id="valoracion-adv" class="btn-valoracion  btn btn-primary btn-color"><div class='loader hidden'></div>{{ trans(\Config::get('app.theme').'-app.valoracion_gratuita.send') }}</button>
                            <br><br>
