	...
	<div class="container" id="return-valoracion">
                ...
                <?=  trans($theme.'-app.valoracion_gratuita.desc_assessment')  ?>
                 <form class="form" id="form-valoracion-adv">
                    ...
                    <div clas="row" >
                        <?=  trans($theme.'-app.valoracion_gratuita.desc_interesting_auctions')  ?>
                        
                   </div>
                   <div clas="row" >
                       <div class="col-md-12">
                           <br>
                            <button type="submit" id="valoracion-adv" class="btn-valoracion  btn btn-primary btn-color"><div class='loader hidden'></div>{{ trans($theme.'-app.valoracion_gratuita.send') }}</button>
                            <br><br>
