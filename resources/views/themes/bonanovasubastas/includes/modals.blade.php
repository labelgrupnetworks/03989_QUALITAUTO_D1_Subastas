	...
	<div class="contentLogin">
		...
		<form id="accerder-user-form-responsive">
			...
			<h5 class="message-error-log text-danger"></h5></p>
                        <button id="accerder-user-responsive" class="btn btn-registro btn-color" type="button"><span>{{ trans(\Config::get('app.theme').'-app.login_register.acceder') }}</span><div style="display: none;" class="loader mini"></div></button>
		...
		<div class="title_login mt30">
                ...
                <a href="{{ \Routing::slug('login') }}" class="btn btn-registro-responsive btn-color">{{ trans(\Config::get('app.theme').'-app.login_register.register') }}</a>
	</div>
</div>
