		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-9 col-lg-9 ">
				<div class="user-account-title-content">
					<div class="user-account-menu-title">{{ trans("$theme-app.user_panel.my_counter_offers") }}</div>
				</div>
										...
										<div class="d-flex">
											...
											<div class="col-xs-12 col-sm-2  account-item-border ">
												<div
													...
													<div class="visible-xs">{{
														trans("$theme-app.user_panel.my_counter_offer") }}</div>
											...
											<div class="col-xs-12 col-sm-2  account-item-border ">
												<div
													...
													<div class="visible-xs">{{ trans("$theme-app.user_panel.condition") }}</div>

													<div style="text-align: center;">
														{{ $inf_lot->pujrep_asigl1 == \App\Models\V5\FgAsigl1_aux::PUJREP_ASIGL1_CONTRAOFERTA_RECHAZADA ? 'RECHAZADA' : 'ACEPTADA' }}
													</div>
