	...
	<div class="grid-banner">
		{!! BannerLib::bannersPorKey('grid-superior', 'banner-gird', ['dots' => false, 'arrows' => false, 'autoplay' => true]) !!}
	</div>
    ...
    <div class="info-auction secondary-color" id="auction__lots">
        ...
        <div class="container">
            <div class="row">
                @if(!empty($auction))
                    @php
					    $url_info = route('urlAuctionInfo',["lang" => \Config::get('app.locale') ,"texto" => \Str::slug($auction->name) ,"cod" => $auction->cod_sub]);
					@endphp
                    <div class="col-lg-12">
