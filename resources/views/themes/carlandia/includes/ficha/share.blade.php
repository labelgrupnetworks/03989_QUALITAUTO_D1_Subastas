<div class="zone-share-social col-xs-12 no-padding d-flex justify-content-space-between">
	...
	<ul class="red ul-format d-flex align-items-center">
		<li>
			<a id="wahtsappEvent_JS" class="d-flex align-items-center justify-content-center color-letter"
				target="_blank" rel="noopener"
				title="{{ trans(\Config::get('app.theme').'-app.lot.share_whatsapp') }}"
				href="https://wa.me/?text=<?=$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>">
				<i class="fab fa-whatsapp"></i></a>
		</li>
		<li>
			<a id="facebookEvent_JS" class=" d-flex align-items-center justify-content-center color-letter"
				target="_blank" rel="noopener"
		...
		<li>
			<a id="emailEvent_JS" class=" d-flex align-items-center justify-content-center color-letter"
				target="_blank" rel="noopener"
				title="{{ trans(\Config::get('app.theme').'-app.lot.share_email') }}"
				href="mailto:?Subject={{ trans("$theme-app.lot.share_affair") }}&body=<?=$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>">
...
<a class="hidden logo-whatsapp-mobile"
	title="{{ trans(\Config::get('app.theme').'-app.lot.share_whatsapp') }}"
	href="https://wa.me/?text=<?=$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>">
