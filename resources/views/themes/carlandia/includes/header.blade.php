    ...
    <nav class="menu-header">
        <div class="menu-responsive hidden-lg">
			...
			<div class="logo-header col-md-3">
				<a href="/{{$lang}}">
					<img class="logo-company img-responsive" src="/themes/{{$theme}}/assets/img/logo.png?a=2"  alt="{{(\Config::get( 'app.name' ))}}">
				</a>
		...
		<div class="call-icons">
			...
			<a href="tel:{{config('app.phoneNumber')}}" class="phone-icon clictelefonoEvent_JS" data-customtitle="900 670 239" style="font-size: 35px; height: 32px;">
				<i class="fa fa-phone" aria-hidden="true"></i>
			</a>
			<a href="https://api.whatsapp.com/send?phone=+34{{config('app.whatsAppNumer')}}&text=" target="_blank" class="whatsapp-icon clicWhatsappEvent_JS hidden-sm hidden-md hidden-lg">
				<i class="fa fa-whatsapp" aria-hidden="true"></i>
			</a>
			<a href="https://api.whatsapp.com/send?phone=0034{{config('app.whatsAppNumer')}}&text=" target="_blank" class="whatsapp-icon clicWhatsappEvent_JS hidden-xs">
        ...
        <div class="user-account @if(Session::has('user')) init-session @endif">
                @if(!Session::has('user'))
                    <div class="user-account-login">
                        <a class="d-flex justify-content-end align-items-center btn_login_desktop btn_login">
    ...
    <div class="login_desktop_content">
        <div class="only-login">
			...
			<div class="login_desktop_title login-call mt-2">
				...
				<br>
				<span>
					<a href="tel:{{config('app.phoneNumber')}}" class="phone-icon" alt="900670239">
