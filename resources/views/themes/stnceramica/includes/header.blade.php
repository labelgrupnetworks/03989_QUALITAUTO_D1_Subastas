    ...
    <nav class="menu-header">
        ...
        <div class="menu-principal">
            ...
            <ul class="menu-principal-content d-flex  align-items-center">
                ...
                @if (!Session::has('user'))
                    <li>
                        <a class="color-letter d-flex link-header justify-content-center btn_login_desktop btn_login align-items-center"
                ...
                @else
                    <li>
                        <a class="color-letter d-flex link-header justify-content-center align-items-center"
                            ...
                            href="{{ \Routing::slug('user/panel/orders') }}"><span>{{ trans($theme . '-app.login_register.my_panel') }}</span>
                        </a>
                    </li>
