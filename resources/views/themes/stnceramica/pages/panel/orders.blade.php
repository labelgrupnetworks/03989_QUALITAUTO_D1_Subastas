                ...
                <div class="col-xs-12 no-padding ">
                    <div class="panel-group" id="accordion">
                            <div class="panel panel-default">
								...
								@php
								$refs = collect($all_inf['lotes'])->pluck('ref_asigl0')->toArray();
								$closeDates = \App\Models\V5\FgAsigl0::select('ffin_asigl0', 'hfin_asigl0', 'ref_asigl0')->where('sub_asigl0', $key_sub)->whereIn('ref_asigl0', $refs)->get();
								@endphp
                                            ...
                                            <div class="user-accout-items-content">
                                                    ...
                                                    ?>
                                                        <div class="user-accout-item-wrapper  col-xs-12 no-padding">
                                                            ...
                                                            <div class="col-xs-12 col-sm-2  account-item-border ">
                                                                    <div class="user-account-item-price  d-flex align-items-center justify-content-center">
																			...
																			<div style="text-align: center;"
																				@if ( ($inf_lot->cod_licit == $inf_lot->licit_winner_bid && ($all_inf["inf"]->tipo_sub=='O' || $all_inf["inf"]->subabierta_sub=='P')) || ($inf_lot->cod_licit == $inf_lot->licit_winner_order && ($all_inf["inf"]->tipo_sub=='W' && $all_inf["inf"]->subabierta_sub == 'O')) )
																					class="mine"
															...
															<div class="col-xs-12 col-sm-2  account-item-border ">
                                                                <div class="user-account-item-date d-flex align-items-center">
                                                                    <div class="visible-xs">Fecha fin</div>
																	@php
