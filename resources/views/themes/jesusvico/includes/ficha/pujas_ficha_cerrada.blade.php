...
<div class="info_single lot-sold col-xs-12 no-padding">
            ...
            <div class="col-sm-12 no-padding">
				...
				<div class="pre d-flex justify-content-space-between pl-1 pr-1 mb-1">
                ...
                @if($cerrado && !empty($precio_venta) && $remate )
                    <div class="pre borded d-flex justify-content-space-between pl-1 pr-1">
