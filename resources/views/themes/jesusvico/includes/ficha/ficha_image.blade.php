...
@if (Session::has('user') && !$retirado)
    <div class="favoritos">
        <a id="del_fav" href="javascript:action_fav_modal('remove')" @class(['lb-text-primary', 'hidden' => !$lote_actual->favorito])>
            <svg class="bi" width="24" height="24" fill="currentColor">
                <use xlink:href="/bootstrap-icons.svg#heart-fill"></use>
            </svg>
        </a>
        <a id="add_fav" href="javascript:action_fav_modal('add')" @class(['lb-text-primary', 'hidden' => $lote_actual->favorito])>
            <svg class="bi" width="24" height="24" fill="currentColor">
...
<div class="slider-thumnail-container d-sm-none">
    ...
    @if (!empty($lote_actual->contextra_hces1))
        <div class="img-360-real img-360-mobile-content" id="js-360-img-mobile" style="display:none"></div>
    @endif
...
@if (!empty($lote_actual->contextra_hces1))
    <div class="d-sm-none">
        <div class="img-360 img360-mobile col-12" id="js-360-btn-mobile" data-active="disabled"
            ...
            <img src="data:image/png;base64,"
                style="position:relative; z-index: 1;" width="40px">
        </div>
    </div>
@endif
    ...
    <div class="minis-content d-flex gap-1 mt-auto">
        ...
        @if (!empty($lote_actual->contextra_hces1))
            <div class="mini-img-ficha position-relative">
                <button class="mini-img-ficha-content img-360-desktop more-img img-360" id="360img-button"
                    data-active="disabled">
                    <img class="img-360-background"
                        src="{{ \Tools::url_img('lote_small', $lote_actual->num_hces1, $lote_actual->lin_hces1, 0) }}">
