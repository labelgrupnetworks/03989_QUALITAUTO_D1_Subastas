			...
			<div class="col-12 col-md-6">
				...
				<div class="lb-border-light" style="padding: 8px;">
					...
					<section class="option-links">
						...
						&nbsp;<a href="sixbid.com">sixbid.com</a>&nbsp; | &nbsp;<a href="numisbids.com">numisbids.com</a>&nbsp;|
						&nbsp;<a href="biddr.ch">biddr.ch</a>&nbsp; | &nbsp;<a href="bidspirit.com">bidspirit.com</a>
					</section>
				</div>
			</div>
			<div class="col-12 col-md-6">
		...
		<div class="row">
			<div class="col-12">
				...
				<div>
					...
					<p class="mb-3">
						Asimismo, y en los caso que la legislación así lo establece, dicha información podrá ser incluida en el Libro de
						la
				...
				<div>
					...
					<p class="mb-3">
						El grupo Jesús Vico garantiza la autenticidad de todos los productos vendidos con carácter vitalicio. En el caso
						de
