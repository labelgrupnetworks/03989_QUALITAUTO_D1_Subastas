...
<div class="row g-0 h-100 mobile-subastas">
	<div class="card card-custom-large h-100 {{ $subasta->cod_sub != $ant_cod_sub ? 'card-mobile-subastas-top' : 'card-mobile-subastas-bottom' }}
		{{ $subasta->cod_sub != $sig_cod_sub ? 'card-mobile-subastas-bottom' : ''}}">

		<div @class(['col-12 card-img-wrapper', 'd-none' => $subasta->cod_sub == $ant_cod_sub])>
			<a href="{{ $url_lotes }}">
