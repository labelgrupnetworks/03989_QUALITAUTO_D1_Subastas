						...
						<svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="21" height="15.545" viewBox="0 0 21 15.545">
							<g id="mail-outline" transform="translate(0.5 0.5)">
								...
								<path id="Trazado_119" data-name="Trazado 119" d="M112,160l6.62,5.927L125.24,160"
									transform="translate(-108.62 -157.502)" fill="none" stroke="#b9b13c" stroke-linecap="round"
						...
						<svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="20.963" height="20.919" viewBox="0 0 20.963 20.919">
							<g id="call-outline" transform="translate(0.519 0.444)">
								<path id="call-outline-2" data-name="call-outline"
									...
									transform="translate(-47.994 -48.012)" fill="none" stroke="#b9b13c" stroke-miterlimit="10"
									stroke-width="1" />
							</g>
						</svg>
						<div>
						...
						<svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21">
							<g id="print-outline" transform="translate(0.5 0.5)">
								<path id="Trazado_208" data-name="Trazado 208"
									...
									transform="translate(-3.25 -3.25)" fill="none" stroke="#b9b20e" stroke-linejoin="round" stroke-width="1" />
								<path id="Trazado_209" data-name="Trazado 209"
									...
									transform="translate(-3.25 -2.75)" fill="none" stroke="#b9b20e" stroke-linejoin="round" stroke-width="1" />
						...
						<svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="21" height="29.885" viewBox="0 0 21 29.885">
							<g id="location-outline" transform="translate(0.5 0.5)">
								<path id="Trazado_212" data-name="Trazado 212"
									...
									transform="translate(-5.687 -2.438)" fill="none" stroke="#b9b20e" stroke-linecap="round"
									stroke-linejoin="round" stroke-width="1" />
								<path id="Trazado_213" data-name="Trazado 213"
									d="M15.438,9.75A2.438,2.438,0,1,1,13,7.312,2.438,2.438,0,0,1,15.438,9.75Z" transform="translate(-3 -0.11)"
									fill="none" stroke="#b9b20e" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" />
							</g>
						</svg>
						...
						<svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21">
							<g id="time-outline" transform="translate(0.5 0.5)">
								<path id="Trazado_214" data-name="Trazado 214" d="M13.25,3.25a10,10,0,1,0,10,10A10,10,0,0,0,13.25,3.25Z"
									...
									stroke-width="1" />
								<path id="Trazado_215" data-name="Trazado 215" d="M13,6.5v7.313h4.875" transform="translate(-2.917 -3.116)"
									fill="none" stroke="#b9b20e" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" />
							</g>
						</svg>
			...
			<div class="col-lg-7 contact-page-form ps-xl-5 mt-5 mt-lg-0">
				...
				<form name="contactForm" id="contactForm" novalidate>
					...
					<div class="form-check mb-2">
						<input class="form-check-input" type="checkbox" value="" id="bool__1__condiciones" name="condiciones"
							value="on" autocomplete="off" required>
