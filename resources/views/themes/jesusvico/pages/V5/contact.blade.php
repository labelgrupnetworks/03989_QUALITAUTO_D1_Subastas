    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-7 contact-page-form">
                <form name="contactForm" id="contactForm" method="post" action="javascript:sendContact()" onsubmit="gtag('event', 'enviar', { 'event_category': 'contacto'});">
                    ...
                    <div class="form-group">
                        ...
                        <br><br>
                        <div class="g-recaptcha col-xs-12"
