...
<section class="post_content">
	<div class="container">
		...
		@if($data['categorys'][$noticias->primary_category_web_blog]->id_category_blog != '2')

		@php
		$url =
		\Routing::slugSeo('blog').'/'.$data['categorys'][$noticias->primary_category_web_blog]->url_category_blog_lang.'/'.$noticias->url_web_blog_lang;
		@endphp

		<div class="row mt-3 mb-5 post-container">
			...
			<div class="col-sm-12 col-xs-12 primer-post">
				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-xs-12 col-md-6">
						<div class="post-conent-principal">
							...
							?>
								...
								<p class="d-flex justify-content-space-between"><span>{{ $noticias->author_web_blog ?? ''}}</span> {{ $fecha }}</p>
							</div>
					...
					<div class="col-xs-12 col-md-offset-2 col-md-4 hidden-xs hidden-sm">
						<img alt="{{$noticias->titulo_web_blog_lang}}" class="img-responsive img-blog"
							src="{{$noticias->img_web_blog}}">
					</div>
				</div>
