                            ...
                            <div class="modal-wrapper">
                                    <div class=" text-center single_item_content_">
                                        ...
                                        <!-- <p id="insert_msg"></p><br/> -->
                                            ...
                                            <button  class=" btn button_modal_confirm modal-dismiss btn-custom">{{ trans(\Config::get('app.theme').'-app.head.close') }}</button>
                    ...
                    <div class="panel-body">
                            <div class="modal-wrapper">
                                    <div class=" text-center single_item_content_">
                                       ...
                                       <p id="insert_msgweb"></p><br/>
									   <a href="/es/subasta/tienda-online_7500-001?order=orden_desc">
