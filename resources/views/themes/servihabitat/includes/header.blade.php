        ...
        <div class="menu-principal">
            ...
            <ul class="menu-principal-content d-flex  align-items-center">
                <span role="button" class="close-menu-reponsive hidden-lg">{{ trans($theme.'-app.head.close') }}</span>
					...
					@if(Session::has('user'))
					<li>
						<a class="color-letter d-flex link-header justify-content-center align-items-center category-button"  href="#"><span>{{ trans($theme.'-app.foot.auctions') }}</span></a>
						<div class="submenuDefault ">
							<div class="  pt-2 pb-2" >
								...
								@endphp
								<div class="categoryOption"><a href="{{ route('allCategories', ['order' => 'active']) }}">{{ trans($theme.'-app.home.all_categories')}}</a></div>
								@foreach ($categories as $k => $category)
										<div class="categoryOption"><a href="{{ route("category",array( "category" => $category["key_ortsec0"], 'order' => 'active')) }}">{{$category["des_ortsec0"]}}</a></div>
								@endforeach
							</div>
					  </div>
					...
					<li>
						<a class="color-letter d-flex link-header justify-content-center align-items-center" href="{{ Routing::translateSeo('pagina').trans($theme.'-app.links.faq') }}">
							<span>{{ trans($theme.'-app.foot.faq')}}</span>
						</a>
					</li>
					...
					@if(Session::has('user'))
					<li>
						<a class="color-letter d-flex link-header justify-content-center align-items-center" href="{{ route('allCategories', ['order' => 'date_desc']) }}">
...
<div class="login_desktop" style="display: none" >
    <div class="login_desktop_content">
        <div class="only-login white-background">
            ...
            <div class="login_desktop_title color-letter">
                <?= trans($theme.'-app.login_register.login') ?>
            </div>
