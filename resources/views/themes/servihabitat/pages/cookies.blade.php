...
$internalCookies['esentials'] = $internalCookies['esentials'] + $internalCookies['preferences'];
unset($internalCookies['preferences']);
?>
							...
							<div class="row">
								...
								<div class="col-xs-4">
									<label class="radio-inline">
										<input type="radio" name="{{ $typeCookie }}" value="1"
											@if(empty($cookiesState) || $cookiesState['all']==1 || !empty($cookiesState[$typeCookie]) && $cookiesState[$typeCookie]==1)
												checked="checked"
											@endif
									...
									<label class="radio-inline">
										<input type="radio" name="{{ $typeCookie }}" value="0"
										@if(!empty($cookiesState) && empty($cookiesState['all']) && empty($cookiesState[$typeCookie]))
											checked="checked"
										@endif
										@if($typeCookie=='esentials') disabled @endif>
