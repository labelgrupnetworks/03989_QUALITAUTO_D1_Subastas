...
<?php
$obsdet_hces1 = \App\Models\V5\FgHces1::select('obsdet_hces1')->where('num_hces1', $data['subasta_info']->lote_actual->num_hces1)->where('lin_hces1', $data['subasta_info']->lote_actual->lin_hces1)->first()->obsdet_hces1;
...
<?php
    ...
    if(!empty($lote_actual)){
        $bread = array();
        $bread[] = array("url" => route('allCategories', ['order' => 'active']), "name" => trans($theme.'-app.foot.auctions'));
