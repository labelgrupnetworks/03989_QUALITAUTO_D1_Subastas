<div class="register-alert">
    ...
    <div class="register-alert-register">
        ...
        <div class="register-alert-register-btn"><a href="{{ \Routing::translateSeo('login') }}">{{ trans(\Config::get('app.theme').'-app.login_register.register') }}</a></div>
    </div>
    <div class="register-alert-suscribe">
        <div class="register-alert-suscribe-title" style="text-transform: uppercase">{{trans(\Config::get('app.theme').'-app.foot.newsletter_title')}}</div>
        <div class="register-alert-suscribe-btn"><a href="#newsletter_secction">{{trans(\Config::get('app.theme').'-app.emails.suscribe')}}</a></div>
...
<section class="subastas-home">
    <div class="container">
        <div class="titulos-home">
                <p style="width:100%">{{ trans(\Config::get('app.theme').'-app.subastas.next_sell') }} (<span id="total_lots_title"></span>)</p>
            </div>
...
<div class="lotes_destacados">
	<div class="container">
		<div class="title_lotes_destacados">
                    <p>{{ trans(\Config::get('app.theme').'-app.lot_list.lotes_destacados') }}<p>
		</div>
...
<p>{html}</p>
            ...
            <div class="col-xs-12 text-center" style="margin: 30px 0">
                <a class="btn-link-home" title="{{ trans(\Config::get('app.theme').'-app.foot.contact')}}" href="<?= \Routing::translateSeo('pagina').trans(\Config::get('app.theme').'-app.links.services')?>">{{ trans(\Config::get('app.theme').'-app.foot.services')}}</a>
                ...
                if(totalpage > 3){
                   console.log(totalpage)
                    if(page > 2){
                        ...
                        if(page < 2){
                            $('.controls-carousel-container').css({"-webkit-transform":"translateY(0px)"});
                        }
