                        ...
                        <?php foreach ($data['subasta_info']->lote_actual->ordenes as $orden) : ?>
                                <div class="ol_model">
                                    <div class="col-lg-6 tipoOrden">
                                        ...
                                        <p data-type="U" @if ($orden->tipop_orlic != 'U')class="hidden" @endif><i class="fa fa-desktop" aria-hidden="true"></i> Subalia</p>
                                    </div>

                                    <div class="col-lg-6 importeOrden">
                                        <p>
                                            <?php if(!empty($data['js_item']['user']['is_gestor'])) { ?>
                                                <span class="licitadorOrden">({{ $orden->cod_licit }})</span>
                                            <?php } ?>
