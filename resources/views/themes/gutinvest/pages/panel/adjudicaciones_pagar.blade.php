					...
					<tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr class="<?php if($i%2==0){ 
                                                    ...
                                                    @if( !empty(\Config::get( 'app.pasarela_web' )))
                                                        <td><span class="text-center"><input type="checkbox" id="{{$i}}" class="add-carrito form-control" name="carrito[{{$i}}]" price="<?= $precio_limpio_calculo ?>" value="{{$puj->ref_csub}}-{{$puj->sub_csub}}"></span></td>
                                                    @endif
							...
							<td onclick="window.location='{{$url_friendly}}'"> {{ $puj->date }} </td>
                                                ...
                                                ">
                                                    <td colspan="4">
                                                        <div class="tit_mi">{{ trans(\Config::get('app.theme').'-app.user_panel.shipping_form') }}</div>
                                                        <span class="">
                                                            @if(1!=1 && $puj->transport_hces1 == 'S')
                                                            <div class="radio">
                                                                <label>
                                                                    <input class="envios id_envios_{{$i}}" type="radio" name="envios[{{$i}}]"  value="10"> Envio <br>
                                                                </label>
                                                            </div>    
                                                            @endif
                                                            <div class="radio">
                                                                <label>                                                            
                                                                    <input class="envios id_envios_{{$i}}" type="radio" name="envios[{{$i}}]" checked="" value="0"> Recoger ({{$puj->obs_alm}})
                                                                </label>
                                                            </div>    
                                                        </span>
                                                    </td>
