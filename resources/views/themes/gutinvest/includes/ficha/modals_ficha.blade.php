                            ...
                            <div class="panel-body">
                                    <div class="modal-wrapper">
                                            <div class=" single_item_content_">
                                                <p class="class_h1  text-center">{{ trans(\Config::get('app.theme').'-app.lot.confirm_bid') }}</p><br/>
                                                <div class="modals-desgloce">
                                                    <div class="styles-modals">
                                                    <span for="bid" class='desc_auc'>{{ trans(\Config::get('app.theme').'-app.lot.you_are_bidding') }} </span> 
                                                    <strong><span class="precio_orden"></span> €</strong>
                                                </div>
                                                <div class="styles-modals">
                                                    <span class='desc_auc'>{{ trans(\Config::get('app.theme').'-app.lot.comision') }} (<span class="porcentaje_comision"></span>%)</span><strong><span class="comision_lot"></span> €</strong>
                                                </div>
                                                <div class="styles-modals carga_embalaje">
                                                    <span class='carga_embalaje'>{{ trans(\Config::get('app.theme').'-app.lot.carga_embalaje') }}</span> <strong><span class="carga_embalaje_price"></span> €</strong>
                                                </div>
                                               
                                                <div class="styles-modals">
                                                    <span class='ivacomision'>{{ trans(\Config::get('app.theme').'-app.lot.iva') }}</span> <strong><span class="ivacomision_price"></span> €</strong>
                                                </div>

                                                <div class="styles-modals">
                                                    <span class=''>{{ trans(\Config::get('app.theme').'-app.lot.price_total') }}</span> <strong><span class="price_total"></span> €</strong>
...
<?php  //estructura necesaria para crear lso elementos del listado de pujas  ?>
    <div id="duplicalte_list_pujas" class="hist_item hidden">
        <span class="col-xs-6">
            ...
            <em class="yo">{{ trans(\Config::get('app.theme').'-app.lot.I') }}</em>
            <em class="uno hint--bottom-right hint--medium" data-hint=""></em>
            <em class="dos hint--bottom-right hint--medium" data-hint="<?= nl2br(trans(\Config::get('app.theme').'-app.lot.puja_automatica')) ?>">A</em>)
            <em class="date"></em>
        </span>
        <span class="col-xs-6">
...
<div id="view_more" class="more hidden col-xs-12 text-right">
    ...
    <span id="hide_bids_text" class="hidden">{{ trans(\Config::get('app.theme').'-app.lot.hidden') }}</span></a>
