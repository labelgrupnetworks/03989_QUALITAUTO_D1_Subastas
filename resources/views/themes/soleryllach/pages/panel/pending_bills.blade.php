        ...
        <div class="col-xs-12">
            <div class="tabs">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        <li role="pagar" class="active" ><a href="{{ \Routing::slug('user/panel/pending_bills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.still_paid_fact') }}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="facturacion_info_data">
                        ...
                        @if (!empty(\Session::get("user.cod")) && \Session::get("user.cod")[0]=="W")
                            <div class="well text-center other">{{ trans(\Config::get('app.theme').'-app.user_panel.pending_validation') }}</div>
                        @else
                            <button id="submit_fact" style="margin-left: 15px; " type="button" class="btn btn-step-reg2" >{{ trans(\Config::get('app.theme').'-app.user_panel.pay') }}</button>
