...
$ministeryLicit = config('app.ministeryLicit', '50');
?>
		...
		<div id="clock">
            <div class="row center-tr">
                ...
                <div class="col-xs-12 col-lg-6 data-logo-wait-info data-content-info-wait">
                    <img class="logo-time-wait img-responsive" src="/themes/{{\Config::get('app.theme')}}/assets/img/logo_blanc.png?a=2"  alt="{{(\Config::get( 'app.name' ))}}">
       ...
       <div id="controles_gestor_box">
           <div class="gestor_buttons">
               <p>{{ trans(\Config::get('app.theme').'-app.sheet_tr.user_conectet') }} <span id="users_conectet"></span></p>
				...
				<button id="clients_credit" class="btn" type="button">{{ "Credito clientes" }}</button>
