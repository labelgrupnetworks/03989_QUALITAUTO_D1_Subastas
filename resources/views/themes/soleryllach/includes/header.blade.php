                    ...
                    <div class="navbar-top-wrapper">
                        <ul>
							@if(!Session::has('user'))
								...
								<li class="hidden-xs hidden-sm"><a class="btn-color" title="{{ trans(\Config::get('app.theme').'-app.login_register.register') }}" href="{{ \Routing::slug('login') }}">{{ trans(\Config::get('app.theme').'-app.login_register.register') }}</a></li>
                            ...
                            @endif
                            <li class="hidden-xs hidden-sm"><a class="btn-live" href="{{ \Routing::slug('logout') }}" >{{ trans(\Config::get('app.theme').'-app.login_register.logout') }}</a></p></li>
                            @endif
                            ...
                            <div class="login_desktop" style="display:none;">
                                ...
                                <form data-toggle="validator" id="accerder-user-form">
                                    ...
                                    <button id="accerder-user" class="btn btn-login-desktop btn-color" type="button">{{ trans(\Config::get('app.theme').'-app.login_register.acceder') }}</button>
                                </form>
                            </div>
                            ...
                            @elseif(\Config::get( 'app.google_translate' ))
                                ...
                                <script type="text/javascript">
                                    function googleTranslateElementInit() {
                                        new google.translate.TranslateElement({pageLanguage: 'es', includedLanguages: 'es,ca,de,fr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
                                    }
                                </script>
            ...
            <div class="col-xs-12">
                <div class="logo">
                    ...
                    <a title="{{(\Config::get( 'app.name' ))}}" href="/{{$lang}}">
                        <img class="img-responsive" src="/themes/{{\Config::get('app.theme')}}/assets/img/logo.svg"  alt="{{(\Config::get( 'app.name' ))}}" style="display: inline-block">
                    </a>
                    <span class="text-right session_name parpadea">
                    @if(\Session::has('user'))
                        ...
                        <ul class="nav-responsive-wrapper">
                            ...
                            <div class="search-component hidden-lg hidden-sm hidden-md">
                                <form  role="search" action="{{ \Routing::slug('busqueda') }}" class="search-component-form formsearch">
                                    ...
                                    <button type="submit" class="btn btn-custom-search"><i class="fa fa-search"></i><div class="loader search-loader" style="display:none;position: absolute;top: -61.50px;right:-0px;width: 30.5px;height: 30.5px;"></div></button>
                                </form>
                            </div>
                        </ul>
