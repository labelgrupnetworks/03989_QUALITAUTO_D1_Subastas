        ...
        @if ($lote_actual->tipo_sub == 'W' && $lote_actual->subabierta_sub == 'O' && $lote_actual->cerrado_asigl0 == 'N')
            <div class="col-lg-12">
                <div class="info_single_title">
                    <div class=" <?= $lote_actual->open_price > 0 ? '' : 'hidden' ?>" id="text_actual_max_bid">
                    ...
                    <div class=" <?= $lote_actual->open_price > 0 ? 'hidden' : '' ?>" id="text_actual_no_bid">
            ...
            <div class="info_single_content">
                @if (
                    ...
                    <a
                        ...
                        <button
                            class="btn btn-lg btn-custom live-btn btn-color"><?= trans(\Config::get('app.theme') . '-app.lot.bid_live') ?></button>
                    </a>
                @endif
                @if (
                    $lote_actual->cerrado_asigl0 == 'N' &&
                    ...
                    <div class="input-group group-pujar-custom">
                        <input class="form-control input-lg control-number" id="bid_modal_pujar" type="text"
                            value="" placeholder="">
                        <div class="input-group-btn">
                            <button class="btn btn-lg btn-custom btn-color" id="pujar_ordenes_w" data-from="modal"
...
<script>
    $(document).ready(function() {
        ...
        $(".cierre_lote").html(format_date_large(new Date("{{ $lote_actual->start_session }}".replace(/-/g,
            "/")), '{{ trans(\Config::get('app.theme') . '-app.lot.from') }}'));
    });
</script>
