    ...
    <div>
        <ul class="nav nav-tabs">
            ...
            <li>
				...
				@if(\Config::get('app.use_credit', 0))
				<li>
				<a data-toggle="tab" href="#credito">{{ trans(\Config::get('app.theme').'-app.sheet_tr.your_credit') }} <span class="novelty">{{ trans(\Config::get('app.theme').'-app.sheet_tr.novelty') }}</span></a>
        ...
        <div class="tab-content">
            ...
            <div id="adjudicaciones" class="tab-pane fade">
				...
				<div id="credito" class="tab-pane fade">
                	@include('content.tr.tiempo_real_user.credito')
				</div>
				@endif
