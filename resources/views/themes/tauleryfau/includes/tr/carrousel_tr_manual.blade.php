...
<div class="carrousel-lots-wrapper">
	...
	<div class="row carrousel-lots-container">
		...
		<div class="col-xs-8 col-sm-10 h-100 d-flex align-items-center lots-carrousel" style="">
			<div class="loader" style="display: none"></div>
			@php
			$carrouselLotes = \App\Models\V5\FgAsigl0::JoinFghces1Asigl0()
			->JoinSessionAsigl0()
			->select('NUM_HCES1', 'LIN_HCES1', 'REF_HCES1', 'IMPSALINI_HCES1', 'WEBFRIEND_HCES1', 'TITULO_HCES1',
			'REF_ASIGL0', 'CERRADO_ASIGL0')
			...
			<div class="lots j-active-info h-100 col-xs-12 col-sm-6 col-md-3" data-ref_asigl0="{{$lote->ref_asigl0}}"
				data-cod_sub="{{$data['subasta_info']->cod_sub}}" data-background-image="url({{$img}})"
				...
				<div class="j-lots-data justify-content-center align-items-center">
					<div class="loader" style="display: none"></div>
					<div class="j-lots-data-load h-100 d-flex flex-column justify-content-end align-items-center">
						<p class="j-lots-price m-0">{{ trans(\Config::get('app.theme').'-app.lot.lot-price') }}:
							<span>{{ $lote->impsalini_hces1 ?? 0 }} €</span></p>
