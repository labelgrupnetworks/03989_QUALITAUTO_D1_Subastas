...
<div class="started hidden zone-tabs">
    <div class="adjudicaciones-header">
        <div class="header-tr_tabs col-xs-12 no-padding">
            ...
            <div class="col-xs-10 col-sm-8 col-xs-7 col-lg-10 title-tables">{{ trans(\Config::get('app.theme').'-app.sheet_tr.description') }}</div>
            <div class=" col-lg-2 col-sm-2 col-xs-3 col-lg-1  title-tables text-right">{{ trans(\Config::get('app.theme').'-app.sheet_tr.adjudicate') }}</div>
        </div>
            ...
            <div id="adjudicaciones_list" class="col-xs-12 no-padding">
                @if (!empty($data['js_item']['user']) && !empty($data['js_item']['user']['adjudicaciones']))
                        ...
                        foreach ($data['js_item']['user']['adjudicaciones'] as $key => $val): ?>
                            <div class="adjudicaciones_model">
                                <div class="col-xs-2 col-lg-1 col-sm-2 adj_ref">
                                    <p></i> <span>{{ trans(\Config::get('app.theme').'-app.sheet_tr.lot') }} {{ $val->ref_asigl1 }}</span></p>
                                </div>
                    ...
                    <div class="adjudicaciones_model hidden" id="type_adj_model">
                        ...
                        <div class="col-xs-7 col-sm-8 col-lg-10 tabs-tr-description">{{ trans(\Config::get('app.theme').'-app.sheet_tr.description') }}</div>
