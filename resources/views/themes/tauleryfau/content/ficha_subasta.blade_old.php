...
<section class="auc-info">
	<div class="container">
		<div class="row it_ro flex body-auctions" style="margin-bottom: 20px;">
			<div class="col-xs-12 col-sm-12 col-md-6 no-padding">
				<div class="col-xs-12 desc-panel-aution">
					...
					<div class="col-xs-12 no-padding links-aution">
						...
						<div class="btn-list-auc flex">
							...
							<div class="btn-view-lot-new"
								style=" width: <?= ($subasta_finalizada)? '100%' : '48%'; ?>;">
								<a class="" style=""
						...
						<div class="auc-observation">
							<div class="auc-observation-content-textarea">
								...
								<?php /*
                                     * if(article_".strtoupper(Config::get('app.locale')) == $data['auction']->descdet_sub )
			...
			<div class="col-xs-12 col-sm-12 col-md-6">
				<div class="col-xs-12 col-sm-12 col-md-4 no-padding info-btns">
					<ul class="single-auction-btn">
						<li class="col-md-12 col-xs-6">
							@if($data['auction']->tipo_sub != 'V')
							<a class="d-flex justify-content-center align-items-center" style="height:52px"
								target="_blank"
							...
							<a class="d-flex justify-content-center align-items-center"
								style="height:52px;cursor:pointer;" href="/files/POLITICA_ENVIOS_2020.pdf"
						...
						<li class="col-md-12 col-xs-6"><a target="_blank"
								href="{{Tools::url_pdf($session->auction,$session->reference,'pre')}}"
								class="price-done"
					...
					<div class="img-info-subasta">
						<div class="img-subasta">
							<div class="img-border-auction">
								<a
									href="<?=!empty($data['sessions'])? Routing::translateSeo('subasta').$session->auction."-".str_slug($session->name."-".$session->id_auc_sessions):''; ?>">
				...
				<div class="col-md-8 col-xs-12 pull-right text-center">
