                                    ...
                                    <div class="btn-data-wrapper">
                                        ...
                                        <div class="btn-group">
                                            <div class="btn-wiew-lot btn-pujar">
                                                <a title="{{ $item->name }}" href="{{ $url_lotes }}" class="btn btn-custom">{{ trans(\Config::get('app.theme').'-app.subastas.see_lotes') }}</a>
                                            </div>
                                            <div class="btn-info-bid">
                                                <a title="{{ $item->name }}" class="flex valign btn-color">{{$item->cuantos}} {{trans(\Config::get('app.theme').'-app.lot_list.lots')}}</a>
                                            </div>                              
                                        </div>                            
                                    </div>
                                </div>
