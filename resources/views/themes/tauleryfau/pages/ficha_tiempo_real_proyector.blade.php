...
<div class="">
    <div style="margin-top:20px; background:white">
            ...
            <div id="clock">
               <div data-countdown="{{strtotime($tiempo) - getdate()[0] }}"  data-format="%D {{trans(\Config::get('app.theme')."-app.msg_neutral.days")}} <br> %H:%M:%S  {{trans(\Config::get('app.theme')."-app.msg_neutral.hours")}}" data-txtend ="{{trans(\Config::get('app.theme')."-app.msg_neutral.auction_coming_soon")}}" class="tiempo"></div>
                   ...
                   <div class="col-lg-11" style="border-right:0;">
                        ...
                        <div class="" id="main_lot_box" style="position:relative;">
                            <div id="main_image_box">
                                ...
                                <!-- INICIADA -->
                                <span id="lote_actual_main" class="pull-left">{{ trans(\Config::get('app.theme').'-app.sheet_tr.lot') }} <strong><span id="info_lot_actual">{{ $data['subasta_info']->lote_actual->ref_asigl0 }} </span></strong> <span id="actual_titulo"> <?php echo  $data['text_lang'][$data['js_item']['lang_code']]->titulo_hces1 ?>  </span></span>
            ...
            <div class="col-sm-4 col-lg-4 fondo2">
                <div class="aside" style="margin-bottom: 15px;margin-top: 0px;">
                    ...
                    <div id="precioSalida" class="precioSalida salida text-center">
                                <p >
                                    <strong>{{ trans(\Config::get('app.theme').'-app.sheet_tr.start_price') }}:</strong><br>
                        ...
                        <h2>{{ trans(\Config::get('app.theme').'-app.sheet_tr.last_bids') }}</h2>
                            ...
                            foreach ($data['subasta_info']->lote_actual->pujas as $puja) : ?>
                                    ...
                                    <div class="pujas_model">
                                        <div class="col-md-3 tipoPuja">
                                            ...
                                            <p data-type="U" @if ($puja->pujrep_asigl1 != 'U')class="hidden" @endif><i class="fa fa-wikipedia-w" aria-hidden="true"></i> </p>

                                        </div>
                                        <div class="col-md-5 importePuja">
                                            <p>
                                        ...
                                        <div class="col-md-4 ordenes">
                                            @if($lat_order)
                                                <p>{{ trans(\Config::get('app.theme').'-app.sheet_tr.last_order') }}</p>
                                            @else
                            ...
                            <div class="pujas_model hidden row" id="type_bid_model">
                                <div class="col-lg-3 tipoPuja">
                                    ...
                                    <p data-type="U" class="hidden"><i class="fa fa-wikipedia-w" aria-hidden="true"></i></p>
                                </div>
                                <div class="col-lg-5 importePuja">
                                    <p>
                                        <?php if(!empty($data['js_item']['user']['is_gestor'])) { ?>
                                ...
                                <div class="col-lg-4 ordenes">
                                    <p class="orden hidden" style="height:30px;">{{ trans(\Config::get('app.theme').'-app.sheet_tr.last_order') }}</p>
                                </div>
                            </div>
