	...
	<div class="row">
		...
		<div class="">
                ...
                <div class='title_orders'>
                    ...
                    <p class='text-right  order'><a href="{{$url_lotes}}">{{ trans($theme.'-app.user_panel.return_subastas') }}</a></p>
                </div>
                <div class="table-responsive">
                            <table class="table table-striped table-custom">
                                ...
                                @endforeach
                                    ...
                                    <p class="text-uppercase text-center"> {{ trans($theme.'-app.user_panel.total_price') }}  <span id="change_price"><?= $total ?></span></p>
                                    ...
                                    <div class="modal-wrapper">
                                            <div class=" text-center single_item_content_">
                                                ...
                                                <span class="ref_orden hidden"></span>
                                                    ...
                                                    <button id="save_change_orden" class="btn btn-color button_modal_confirm btn-custom">{{ trans($theme.'-app.lot.confirm') }}</button>
                                                    <div class='mb-10'></div>
                                                     <div class='mb-10'></div>
                                                    <ul class="items_list">
