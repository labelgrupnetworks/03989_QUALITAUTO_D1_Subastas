                            ...
                            @foreach($all_inf['lotes'] as $inf_lot)
                             ...
                             <!-- Lotes en vista desktop-->
                                 <div class="custom-wrapper flex  valign">
                                    ...
                                    <input type="checkbox" checked="" id="{{$i}}" class="filled-in add-carrito form-control" cod_sub="{{$inf_lot->sub_csub}}" name="carrito[{{$i}}]" calc_envio="{{$calc_envio}}" price="<?= $precio_limpio_calculo ?>" value="{{$inf_lot->ref_csub}}-{{$inf_lot->sub_csub}}">
                                        <label for="{{$i}}"></label>
                                    @endif
                                    </div>
