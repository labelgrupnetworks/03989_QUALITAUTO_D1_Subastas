		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="user-datas-title title-collapse" data-toggle="collapse" data-target="#fact_accordion">
					...
					<p>{{ trans($theme.'-app.user_panel.billing_address') }}</p>
					<p><small><i class="fa fa-info-circle" aria-hidden="true"></i> {!! trans($theme.'-app.user_panel.billing_address_info') !!}</small>
			...
			<div class="col-xs-12">
				<div class="user-datas-title title-collapse" data-toggle="collapse"
					...
					<p>{{ trans($theme.'-app.user_panel.shipping_addresses') }} <span
					...
					<div class="panel-heading">
						<p class="panel-title">
							...
							<label class="w-100 d-flex align-items-center address-name-wrapper" for="fav_address_{{$address->codd_clid}}">
								...
								<span
									class="gold clearfix">({{ trans($theme.'-app.user_panel.address_predeterminated') }})</span>
								@endif
								...
								<span style="margin-left: auto" class="edit_address-span">{{ trans($theme.'-app.user_panel.edit_address') }}</span>
						...
						<p class="panel-title">
							...
							<a class="" data-toggle="collapse" data-parent="#accordion" href="#addres_new" cod="new">
								<label for="" class="w-100">
									...
									<span>{{ trans($theme.'-app.user_panel.add_address') }}</span>
								</label>
							</a>
