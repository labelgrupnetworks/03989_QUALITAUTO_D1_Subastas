...
<div class="orders-auction_lot {{ $inf_lot->ref_asigl0 }}-{{ $inf_lot->cod_sub }}">
    ...
    <div class="lot-image">
        <img class="img-responsive" src="{{ Tools::url_img('lote_medium', $inf_lot->num_hces1, $inf_lot->lin_hces1) }}">
    </div>
        ...
        @if ($isNotClose)
            <button
                ...
                <p @class(['js-place-bid', 'hidden' => $bid_mine])>
                    ...
                    <span id="button-escalado" value="{{ $nextScale }}">{{ Tools::moneyFormat($nextScale) }}</span>
