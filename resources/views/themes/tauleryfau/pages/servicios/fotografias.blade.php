        ...
        <div class="row">
            ...
            <div class="princiapl-bar-wrapper">
                    <div class="principal-bar-title">
                        <h3>{{ trans($theme.'-app.services.photo_colecction') }}</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="custom-bar-title mb-4">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                            <div>{{ trans($theme.'-app.services.the_best_photos') }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="custom-bar-title mb-4">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                            <div>{{ trans($theme.'-app.services.formats') }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="custom-bar-title mb-4">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                            <div>{{ trans($theme.'-app.services.fill_and_calculate') }}</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12 col-md-offset-1">
                        <form id="form-photographic-adv" >
                            ...
                            <div class="form-group col-sm-4 col-xs-12 mb-1 ">
                                <label class="form-custom-encapsulacion-label" >{{ trans($theme.'-app.services.label_services') }}</label>
                                <select name="servicio" class="d-block w-100 custom-select">
                                    <option value="foto2d">{{ trans($theme.'-app.services.photo2d') }}</option>
                                    <option value="canto">{{ trans($theme.'-app.services.photo_cant') }}</option>
                                    <option value="imagen360">{{ trans($theme.'-app.services.image360') }}</option>

                                </select>
                            </div>
                            <div class="form-group col-sm-4 col-xs-12 mb-1 ">
                                <label class="form-custom-encapsulacion-label" >{{ trans($theme.'-app.services.label_format') }}</label>
                                <select name="formato" class="d-block w-100 custom-select">
                                    <option value="pendrive">{{ trans($theme.'-app.services.pendrive') }}</option>
                                    <option value="tarjeton">{{ trans($theme.'-app.services.big_card') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-encapsulacion-buttons col-xs-12 mb-4 mt-1">
                                <div class="button-calcular col-xs-12 pl-0 p-0"><button type="submit" class=" w-100">{{ trans($theme.'-app.services.send') }}</button></div>
                        </div>
