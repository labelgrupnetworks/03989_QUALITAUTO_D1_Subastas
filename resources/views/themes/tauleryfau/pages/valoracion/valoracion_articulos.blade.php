        ...
        <div class="row pt-4 mb-4">
            <div class="col-sm-6 col-xs-12 mb-4">
                <div class="valoracion-imagen">
                    <img class="img-responsive" src="/themes/{{\Config::get('app.theme')}}/img/servicios/foto-portada-articulo.jpg">
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                            <div>{{ trans(\Config::get('app.theme').'-app.services.get_valoration') }}</div>
                    </div>
                </div>
            </div>
        </div>
