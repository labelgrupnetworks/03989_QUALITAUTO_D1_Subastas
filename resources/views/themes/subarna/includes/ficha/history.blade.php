...
<div id="historial_pujas" @class(['hist', 'hidden' => $num_pujas == 0])>
    <p class="hist_title ">
        {{ trans($theme . '-app.lot.history') }}

        {{-- (<span class="num_pujas"></span>
        {{ trans($theme . '-app.lot.bidding') }}) --}}
    </p>

	<div class="hist_content" id="pujas_list"> </div>
</div>
