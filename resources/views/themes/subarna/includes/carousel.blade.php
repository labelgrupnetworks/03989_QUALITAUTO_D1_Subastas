        ...
        <div class="item_home">
            ...
            @if( $bann->retirado_asigl0 =='N')
                @if( \Config::get('app.estimacion') || \Config::get('app.impsalhces_asigl0'))
                    <p class="salida">
						@if($bann->tipo_sub == "V")
						{{ trans($theme.'-app.subastas.price_sale') }} {{ \Tools::moneyFormat($bann->no_formated_impsalhces_asigl0 + ($bann->no_formated_impsalhces_asigl0 * ($bann->comlhces_asigl0/100) * 1.21)," €",2  ) }}
