<div class="sub_panel">
	<form id="password_recovery">
		...
		<div class="acenter text-center">
			<button type="button" class="btn btn-step-reg password_recovery_button" onclick='password_recovery("{{\App::getLocale()}}")'>{{ trans($theme.'-app.login_register.send_email') }}</button>
		</div>
	</form>
