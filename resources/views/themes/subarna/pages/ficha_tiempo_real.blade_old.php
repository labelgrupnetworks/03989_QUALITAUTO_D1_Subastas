...
<div class="">
    <div style="margin-top:20px; background:white">
            ...
            <div id="clock" style="display: block">
                                <div><img style="max-width: 300px; display: block; margin: 0 auto; margin-top: 100px; margin-bottom: 50px; " src="/themes/{{\Config::get('app.theme')}}/assets/img/logofooter.png"  alt="{{(\Config::get( 'app.name' ))}}"></div>
                    ...
                    <div class="col-lg-6" style="border-left:0;">
                        ...
                        <?php // FIN MODO RESPONSIVE PARA DATOS */ ?>
                            ...
                            */ ?>
                            ...
                            <!-- puja actual -->
                            <div class="salida text-center pactual">
                                <p>
