                ...
                <div class="user-accounte-titles-link col-xs-12 no-padding">
                    <ul class="ul-format d-flex justify-content-space-between flex-wrap" role="tablist">
                        <li role="pagar" class="active panel-collapse align-items-center d-flex justify-content-space-between w-100" href="#lot_pend" data-toggle="collapse">
                            <a class="color-letter" href="{{ \Routing::slug('user/panel/allotments/outstanding') }}" >{{ trans($theme.'-app.user_panel.still_paid') }}</a>
							<div class="toggle-open-close">
								<span class="toggle-open" style="display: none">{{ trans($theme.'-app.user_panel.open') }}</span>
								<span class="toggle-close">{{ trans($theme.'-app.user_panel.hide') }}</span>
							</div>
						</li>
                    </ul>
                </div>
