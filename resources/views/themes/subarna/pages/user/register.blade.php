            ...
            <div class="container register pb-5">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-xs-12 general-container">
                        <h1 class="page-title">{{ trans($theme . '-app.login_register.crear_cuenta') }}</h1>
                        ...
                        <form id="registerForm" method="post" action="javascript:submit_register_form()">
                            ...
                            <input class="form-control" id="pri_emp" name="pri_emp" type="hidden" value="F">
                            ...
                            @else
                                <div class="well">
                                    ...
                                    <div>
                                        <input class="form-contro" id="shipping_address" name="shipping_address"
                            ...
                            <div class="well">
                                ...
                                <div class="datos_condiciones">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label for="bool__1__condiciones">{!! trans($theme . '-app.login_register.read_conditions') !!} (<a
