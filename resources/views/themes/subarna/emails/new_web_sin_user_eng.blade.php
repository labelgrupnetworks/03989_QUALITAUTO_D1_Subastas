...
<table border="0" width="600">
  ...
  <tr>
    <td colspan="5" style="padding:20px 10px;font-family:'Helvetica',Arial,sans-serif;font-size:14px;color: #6e6d6d;" bgcolor="#fff">        
        ...
        We are pleased to announce our – <a href="https://www.subarna.net/">www.subarna.net</a><br><br>

        As a Subarna user, we encourage you to complete your registration for place bids, consult and process all operations that you can do, both in our new online auctions and in our traditional hammer auction. <br>
        <br>
        ...
        For any questions, please contact us at  <a href="mailto:subarna@subarna.net">subarna@subarna.net</a> <br> or call us at  <a href="tel:+34932156518 ">932 15 65 18 </a>. 
        <br><br>
