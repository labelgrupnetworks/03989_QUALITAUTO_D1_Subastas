    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                ...
                <p class="newsletter-subtittle">{{ trans(\Config::get('app.theme') . '-app.foot.newsletter_description') }}
                </p>
            </div>
            <div
            ...
            <div
                ...
                <div class="form-check">
                    <p class="newsletter-legalinfo">
                        {{ trans(\Config::get('app.theme') . '-app.foot.newsletter_legalinfo') }}</p>
                    ...
                    <label class="form-check-label" for="condiciones">{!! trans(\Config::get('app.theme') . '-app.emails.privacy_conditions') !!}</label>
                </div>
            </div>
        </div>
    </div>
