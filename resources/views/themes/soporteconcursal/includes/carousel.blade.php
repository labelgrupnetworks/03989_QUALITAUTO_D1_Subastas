 ...
 <?php
    ...
    $precio_salida = (!empty($bann->impsalweb_asigl0) && $bann->impsalweb_asigl0) != 0 ? \Tools::moneyFormat($bann->impsalweb_asigl0) : \Tools::moneyFormat($bann->imptas_asigl0);
?>
            ...
            <div class="data-price">
                ...
                <div class="row">
                    <div class="salida col-xs-12 text-center ">
                        <p class="salida-title mb-0">{{ trans(\Config::get('app.theme').'-app.subastas.price_sale') }}</p>
                        <div class="salida-title mt-1 letter-price-salida"> {{$precio_salida}} {{ trans(\Config::get('app.theme').'-app.subastas.euros') }}</div>
                    </div>
                    ...
                    <div class="salida fs-12 col-xs-12 text-center">
                        @if ( ($subasta_online || $subasta_abierta_P) &&  $hay_pujas)
                            ...
                            <div class="letter-price-salida salida-title mt-1">{{ \Tools::moneyFormat($bann->max_puja,false,0)}} €</div>
