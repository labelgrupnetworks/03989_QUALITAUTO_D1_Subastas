            ...
            <div class="row">
                    <div class="auctions-list col-xs-12">
                            ...
                            <?php
								...
								//cantidad de lotes y url en caso de haber uno
								$lotes = App\Models\V5\FgAsigl0::select('REF_ASIGL0', 'NUM_HCES1', 'WEBFRIEND_HCES1', 'TITULO_HCES1')
										->joinFghces1Asigl0()
										->JoinSessionAsigl0()
										->where('SUB_ASIGL0', $subasta->cod_sub)
