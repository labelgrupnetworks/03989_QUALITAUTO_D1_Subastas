			...
			<div class="col-xs-12 general-container">
				...
				<form method="post" id="registerForm" action="javascript:submit_register_form()">
					...
					<div class="well">
						...
						<div class="datos_left registerEnterprise" style="display: none">
							<label>{{ trans(\Config::get('app.theme').'-app.login_register.position') }}</label>
							{!!FormLib::Text("cargo",0,"", "maxlength='15'")!!}
						</div>
					...
					<div class="well">
						...
						<div class="datos_condiciones">
							...
							<br>
							<div class="checkbox-container condiciones2 col-xs-12">
								{!! $formulario->condiciones2!!}
								<label for="bool__1__condiciones2">
