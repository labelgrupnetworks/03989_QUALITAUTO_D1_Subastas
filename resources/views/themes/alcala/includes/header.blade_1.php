    ...
    <div class="container">
        ...
        <div class="row mini-menu ">
            ...
            <div class="search float-r pull-right" id="minimenu-idiomas">
                ...
                <div class="bloque">
                    <a href="/es" style="margin-right:5px;"><img src="/themes/{{$theme}}/assets/img/lang_es.png" alt=""></a>
                    <a href="/en" style="margin-right:5px;"><img src="/themes/{{$theme}}/assets/img/lang_en.png" alt=""></a>
                    <a href="/cn" style="margin-right:5px;"><img src="/themes/{{$theme}}/assets/img/lang_cn.png" alt=""></a>
                </div>
                ...
                <div class="bloque">
                    ...
                    <br>
                    <span><img src="/themes/{{$theme}}/assets/img/ico-whatsapp.png" alt="WhatsApp" width="11"> +34 616 095 044</span>
                </div>

                <div class="bloque">
                    <a title="{{ trans($theme.'-app.foot.how_to_buy') }}" href="<?php echo \Routing::translateSeo('pagina').trans($theme.'-app.links.how_to_buy')?>"><img src="/themes/{{$theme}}/assets/img/pagoonline.jpg" alt="" height="11"></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <li>
                  @if(!Session::has('user'))
                    <div class="user-account-login">
                        <a class="flex-display justify-center align-items-center btn_login_desktop btn_login color-letter" title="<?= trans($theme.'-app.login_register.login') ?>" href="javascript:;">
    ...
    <div class="login_desktop_content">
        <div class="only-login white-background">
            ...
            <div class="create-account-link">
                <a class="" title="{{ trans($theme.'-app.login_register.register') }}" href="{{ \Routing::slug('login') }}">{{ trans($theme.'-app.login_register.register') }}</a>
            </div>
        </div>
    </div>
    </div>
