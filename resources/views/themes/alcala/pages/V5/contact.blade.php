    ...
    <div class="panel-group" id="accordion">
        ...
        <div class="bloque-princi">
            ...
            <div class="panel-heading heading">
                ...
                <h5 class="panel-title">
                    <a onclick="javascript:$('#departamentos').toggle('blind');" id="link_departamento">
                        {{trans($theme.'-app.global.departamentos') }}<span>+</span>
                    </a>
                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div style="padding: 20px">
                                <h4>{{trans($theme.'-app.global.departamento') }}</h4>
                                <hr>
                        ...
                        <div class="col-xs-12 col-md-8 contact-page-form">
                            <div style="padding: 20px 20px 0 0">
                                <h4>{{trans($theme.'-app.global.form_contact') }}</h4>
                                <hr>
            ...
            <div class="panel-heading heading">
                ...
                <h5 class="panel-title">
                     <a onclick="javascript:$('#mapa').toggle('blind');">{{trans($theme.'-app.global.mapa') }}<span>+</span></a>
                </h5>
                ...
                <div id="mapa" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="info-box col-xs-12 col-md-3">
                            ...
                            <p><strong>{{trans($theme.'-app.global.metro') }}:</strong><br>Retiro (L2)<br>Príncipe de Vergara (Líneas 2 y 9)</p>
                            <p><strong>{{trans($theme.'-app.global.autobuses') }}:</strong><br>
