...
<div class="container">
	<div class="row">
		<div class="col-xs-12 col-sm-12">
			<h1 class="titlePage"><?= trans($theme.'-app.lot_list.ver_ofertas') ?></h1>
		</div>
	</div>
</div>
<div id="prova2">
	...
	<div class="row">
		...
		<div class="">
                ...
                <div class='title_orders'>
                    ...
                    <p class='text-right  order'><a href="javascript:history.back(1)">{{ trans($theme.'-app.user_panel.return_subastas') }}</a></p>
                </div>
                <div class="table-responsive">
                            <table class="table table-striped table-custom">
                                ...
                                <form class="save_orders">
                                        {{ csrf_field() }}
                                           <tr id="{{$inf_lot->cod_sub}}-{{$inf_lot->ref_asigl0}}">
                                               <td scope="row"><img src="/img/load/lote_small/{{Config::get('app.emp').'-'.$inf_lot->numhces_asigl0. '-' .$inf_lot->linhces_asigl0.'.jpg'}}" height="42" width="42"></td>
                                               ...
                                               <td><input class="btn btn-success" type="submit" value="{{ trans($theme.'-app.user_panel.save') }}"></td>
                                               <td><input class="btn btn-danger delete_order" type="button" ref="{{$inf_lot->ref_asigl0}}" sub="{{$inf_lot->cod_sub}}" value="{{ trans($theme.'-app.user_panel.delete') }}"></td>
                                           </tr>
                                        </form>
                                ...
                                @endforeach
                                    ...
                                    <p class="text-uppercase text-center"> {{ trans($theme.'-app.user_panel.total_price') }}  <span id="change_price"><?= \Tools::moneyFormat($total,'',true) ?></span> {{ trans($theme.'-app.subastas.euros') }}</p>
                                    ...
                                    <div class="modal-wrapper">
                                            <div class=" text-center single_item_content_">
                                                ...
                                                <span class="ref_orden hidden"></span>
                                                    ...
                                                    <button id="save_change_orden" class="btn button_modal_confirm btn-custom">{{ trans($theme.'-app.lot.confirm') }}</button>
                                                    <div class='mb-10'></div>
                                                     <div class='mb-10'></div>
                                                    <ul class="items_list">
