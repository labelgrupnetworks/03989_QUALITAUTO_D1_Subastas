            ...
            <ul class="menu-principal-content d-flex justify-content-center align-items-center">
                ...
                ?>
                  ...
                  <li style="position:relative" class="hidden-sm hidden-xs hidden-sm  hidden-md  ">
                    <a id="JSmenu-subastas" class="color-letter d-flex link-header justify-content-center align-items-center" href="#" >
                       <span>{{ trans(\Config::get('app.theme').'-app.foot.auctions')}}</span>
                    </a>
                      <div class="menu-subastas">
                           <a class="color-letter d-flex link-header" href="{{ \Routing::translateSeo('presenciales') }}?f=2">
                                <span>{{ trans(\Config::get('app.theme').'-app.foot.active_auctions')}}</span>
                           </a><br>
                            <a class="color-letter d-flex link-header" href="{{ \Routing::translateSeo('subastas-historicas') }}">
                                <span>{{ trans(\Config::get('app.theme').'-app.foot.historico')}}</span>
                           </a>
                      </div>
                    </li>
                    <li class="flex-display hidden-lg">
                        <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans(\Config::get('app.theme').'-app.home.home')}}" href="{{ \Routing::translateSeo('presenciales') }}?f=2">
                            <span>{{ trans(\Config::get('app.theme').'-app.foot.active_auctions')}}</span>
                        </a>
                    </li>
                    <li class="flex-display hidden-lg">
                        <a class="color-letter flex-display link-header justify-center align-items-center" title="{{ trans(\Config::get('app.theme').'-app.home.home')}}" href="{{ \Routing::translateSeo('subastas-historicas') }}">
                            <span>{{ trans(\Config::get('app.theme').'-app.foot.historico')}}</span>
                        </a>
                    </li>
                ...
                @if(!empty($has_subasta))
                    <li>
                        <a class="color-letter flex-display link-header justify-center align-items-center" href="{{ \Routing::translateSeo('subastas-online') }}?f=1"><span>{{ trans(\Config::get('app.theme').'-app.foot.online_auction')}}</span></a>
                    </li>
                @endif
