        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3 text-center">
                        <a class="footer-link"
                            title="{{ trans(\Config::get('app.theme') . '-app.foot.term_condition') }}"
            ...
            <div class="col-xs-12 col-md-3 mt-2">
                <a target="_blank" href="https://www.numisbids.com">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/NumisBids.png" alt="www.numisbids.com">
                </a>
            </div>
            <div class="col-xs-12 col-md-2 mt-2">
                <a target="_blank" href="https://www.biddr.com/">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/biddr.svg"
                        alt="www.biddr.com/about/about">
                </a>
            </div>
            <div class="col-xs-12 col-md-2 mt-2">
                <a target="_blank" href="https://silicua.bidinside.com/">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/Logo-en.png" alt="www.bidinside.com">
                </a>
            </div>
            <div class="col-xs-12 col-md-2 mt-2">
                <a target="_blank" href="https://emax.bid/it/">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/emax-bid.png" alt="emax.bid/it/">
                </a>
            </div>
            <div class="col-xs-12 col-md-2 mt-2">
                <a target="_blank" href="https://www.anvar.es/">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/anvar.png" alt="www.anvar.es/">
                </a>
            </div>
            <div class="col-xs-12 col-md-1 mt-2">
                <a target="_blank" href="https://numisane.org/">
                    <img class="img-responsive center-block"
                        src="/themes/{{ \Config::get('app.theme') }}/assets/img/logoANE.gif" alt="numisane.org/">
                </a>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                <img class="img-responsive"
                    src="/themes/{{ \Config::get('app.theme') }}/assets/img/Cartel_Empresas.webp" alt="">
            </div>
        </div>
    </div>
