                 ...
                 @if( !$retirado && !$fact_devuelta)
                    ...
                    @if( $awarded || $devuelto)
                      <p class="salida">
                        ...
                        <p class="salida-title extra-color-one">{{ trans(\Config::get('app.theme').'-app.subastas.buy_to') }}: <span class="pill">{{ $item->formatted_actual_bid }} {{ trans(\Config::get('app.theme').'-app.subastas.euros') }}</span></p>
