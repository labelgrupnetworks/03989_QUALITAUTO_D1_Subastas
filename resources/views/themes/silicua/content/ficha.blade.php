        ...
        <div class="row">
           ...
           ?>
                ...
                <div class="col-xs-12 no-padding hidden-xs">
                    ...
                    @elseif($cerrado &&  ($desadjudicado || !empty($lote_actual->himp_csub) || ($sub_historica && !empty($lote_actual->impadj_asigl0))))
                        <div class="retired" style ="">
...
<div class="container">
    <div class="col-xs-12 no-padding favoritos">
       <a class="secondary-button col-xs-12 col-md-2 <?= $lote_actual->favorito? 'hidden':'' ?>" id="add_fav" href="javascript:action_fav_modal('add')">
           {{ trans(\Config::get('app.theme').'-app.lot.add_to_fav') }}
       </a>
       <a class="secondary-button col-xs-12 col-md-2 <?= $lote_actual->favorito? '':'hidden' ?>" id="del_fav" href="javascript:action_fav_modal('remove')">
