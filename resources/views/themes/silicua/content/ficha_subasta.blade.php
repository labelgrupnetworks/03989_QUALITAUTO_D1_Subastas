    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-xs-12 col-sm-5 info-auction-info" style="">
                    ...
                    <a title="{{ trans(\Config::get('app.theme').'-app.subastas.see_lotes') }}" style="text-decoration: none;" href="<?= Routing::translateSeo('subasta') . $session->auction . "-" . str_slug($session->name . "-" . $session->id_auc_sessions) ?>">
