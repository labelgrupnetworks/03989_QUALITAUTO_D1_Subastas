                                ...
                                <div class="panel-title">
                                    ...
                                    <form id="pagar_lotes_{{$all_inf['inf']->cod_sub}}" >
                                        ...
                                        <div class="user-account-heading hidden-xs d-flex align-items-center justify-content-space-between">
                                            <div class="col-xs-12 col-sm-9  col-one user-account-item">
                                                    {{ trans(\Config::get('app.theme').'-app.user_panel.lot') }}
                                            </div>
                                            <div class="col-xs-12 col-sm-3 col-one user-account-fecha">
                                                    ...
                                                    <div class="user-accout-item-wrapper  col-xs-12 no-padding">
                                                        ...
                                                        <div class="col-xs-12 col-sm-9 col-one user-account-item ">
                                                            ...
                                                            <div class="col-xs-12 col-sm-2 no-padding ">
                                                              <a href=" {{$url_friendly}}">  <img src="{{ \Tools::url_img("lote_small", $inf_lot->num_hces1, $inf_lot->lin_hces1) }}" class="img-responsive"> </a>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-8 col-sm-offset-1 no-padding">
                                                                    ...
                                                                    <div class="user-account-item-lot">  <a href=" {{$url_friendly}}"><span>{{ trans(\Config::get('app.theme').'-app.user_panel.lot') }} {{$inf_lot->ref_asigl0}}</span> </a></div>
                                                                    <div class="user-account-item-title"> <a href=" {{$url_friendly}}">{{$inf_lot->titulo_hces1?? $inf_lot->descweb_hces1}} </a></div>
								...
								@if(!$tipo_pago_global)
									<div class="adj color-letter  align-items-center justify-content-space-between">
										@if($all_inf['inf']->compraweb_sub == 'S' && (!empty(Config::get('app.merchantIdUP2')) || !empty(Config::get('app.paymentRedsys'))))
											...
											@endif
											<div class="col-xs-12 col-sm-3 total-price">
