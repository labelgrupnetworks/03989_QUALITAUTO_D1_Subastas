<div class="sub_panel">
    <form id="password_recovery">
        <div class="row d-flex justify-content-center">
            <div class="col-sm-8">
                <label class="mb-2">{{ trans($theme . '-app.login_register.insert_email') }}</label>
        ...
        <div class="acenter text-center">
            <button type="button" class="btn btn-outline-lb-primary"
                onclick='password_recovery("{{ \App::getLocale() }}")'>{{ trans($theme . '-app.login_register.send_email') }}</button>
        </div>
    </form>
</div>
