    ...
    <div class="w-100 d-flex align-items-center justify-content-between">
        ...
        @if ($not_buyed_with_user_logged && $canBuy)
            <a class="btn btn-lb-primary btn-medium"
                href="mailto:yolandachicharro@ansorena.com?subject={{ trans("$theme-app.lot.mail_not_selled_subject", ['cod_sub' => $lote_actual->sub_hces1, 'ref' => $lote_actual->ref_asigl0]) }}">
