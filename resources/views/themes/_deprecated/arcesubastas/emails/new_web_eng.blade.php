...
<table border="0" width="600">
  ...
  <tr>
    <td colspan="5" style="padding:20px 10px;font-family:'Helvetica',Arial,sans-serif;font-size:14px;color: #6e6d6d;" bgcolor="#fff">      
        ...
        We are pleased to announce our NEW WEBSITE – <a href="https://www.arcesubastas.com/">www.arcesubastas.com</a><br>
        ...
        <br>
        To change the password, just enter to your <a href="https://www.arcesubastas.com?view_login=true">BALCLIS ACCOUNT</a> and make all the modifications that you think are convenient. <br>
        <br>
        ...
        <br><br>
        If you wish to delete the account or have any questions, please contact us at <a href="mailto:info@arcesubastas.com">info@arcesubastas.com</a> or call us at <a href="tel:+34932021000">93 202 10 00</a>. 
        <br><br>
  ...
  <tr>
    <td colspan="5">
		<table border="0" width="600" bgcolor="#f4f4f4">
			...
			<tr>
                            <th style="font-size:11px;font-family:'Helvetica',Arial,sans-serif;color:#6e6c6d;font-weight:normal;padding-top:10px;"> Any questions? Get in touch <a style="color:#6e6c6d;" href="https://www.arcesubastas.com/es/pagina/contacto"> here</a> with our <br>customer service team.<br><hr style="border-left:none;border-top:none;border-right:none;border-bottom:1px solid #a7966c;height:1px;width:40%;margin:0 auto;margin-top:14px;"></th>
			</tr>
			<tr>
