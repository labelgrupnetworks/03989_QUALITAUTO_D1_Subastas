        ...
        <div class="single">
            <div class="col-xs-12 col-md-7">
                <div class="col-xs-12 col-sm-10 col-md-10 hidden-xs">
                    ...
                    @elseif($lote_actual->cerrado_asigl0 == 'S' &&  (!empty($lote_actual->himp_csub) || ($lote_actual->subc_sub == 'H' && !empty($lote_actual->impadj_asigl0))))
                            <div class="retired" style ="background:#0B5345;text-transform: lowercase;">
				...
				<!-- Inicio Galeria Desktop -->
                    ...
                    <div class="owl-theme owl-carousel visible-xs" id="owl-carousel-responsive">
                        <?php foreach($lote_actual->imagenes as $key => $imagen){?>
                            ...
                            <img style="    max-width: 100%; max-height: 190px;top: 50%; transform: translateY(-50%); position: relative; width: auto !important;    display: inherit !important;    margin: 0 auto !important;" class="img-responsive" src="{{ \Tools::url_img("lote_medium", $lote_actual->num_hces1, $lote_actual->lin_hces1, $key) }}" alt="{{$lote_actual->titulo_hces1}}">
                        </div>
                        <?php } ?>
                    </div>
                    @if(Session::has('user') &&  $lote_actual->retirado_asigl0 =='N')
