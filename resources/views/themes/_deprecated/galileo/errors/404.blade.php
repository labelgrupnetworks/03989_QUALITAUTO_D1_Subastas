            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <div class="content error404">
                        ...
                        <div class="title" style="font-weight: 600;">{{ trans(\Config::get('app.theme').'-app.global.page_not_found') }}</div>
                        <a style="color: white; font-weight: 600;" href="/{{\App::getLocale()}}">{{ trans(\Config::get('app.theme').'-app.global.go_home') }}</a>
                    </div>
                </div>
            </div>
        </div>
