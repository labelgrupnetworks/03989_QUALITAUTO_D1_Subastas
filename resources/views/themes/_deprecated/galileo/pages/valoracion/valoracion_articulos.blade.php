            ...
            <div class="row">
                ...
                <form id="form-valoracion-adv" class="form">
                    ...
                    <div class=" col-xs-12 content-form-valuations no-padding">
                        ...
                        <div class="col-lg-6 col-xs-12 no-padding inputs-custom-group d-flex flex-direction-column">
                            <label class="" for="exampleTextarea" style="font-weight: normal; font-size: 12px"><?=  trans(\Config::get('app.theme').'-app.valoracion_gratuita.message')  ?></label>
