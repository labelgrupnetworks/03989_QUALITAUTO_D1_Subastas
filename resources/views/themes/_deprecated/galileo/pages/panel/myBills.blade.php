        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 col-lg-9 ">
                ...
                <div class="user-accounte-titles-link">
                    <ul class="ul-format justify-content-space-between d-flex flex-wrap" role="tablist">
                        <li role="pagar"><a class="color-letter" href="{{ \Routing::slug('user/panel/pending_bills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.still_paid') }}</a></li>
                        <li role="pagadas" class="active"  ><a class="color-letter" href="{{ \Routing::slug('user/panel/myBills') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.bills') }}</a></li>   
                    </ul>
                </div>

                        <div class="select_order col-md-12 no-padding">
                                <div class="col-md-4">
                                    <form  method='get'>
                                    <select id="order_selected" class="form-control filters-bill-select submit_on_change" name="order">
                                        ...
                                        <option <?= !empty(Request::input('order')) &&  Request::input('order') == 'lasted'?'selected':''?> value="lasted">
                                             {{ trans(\Config::get('app.theme').'-app.user_panel.more_lasted') }}
                                        </option>
                                    </select>
                                    </form>
                                </div>
                                ...
                                <div class="factura_box col-xs-12 col-md-12">
                                    ...
                                    <div class="factura_datos col-xs-12 col-md-9">
                                        <div class="factura_titulo">
                                            <div>{{ trans(\Config::get('app.theme').'-app.user_panel.n_bill') }} {{$bills->afra_cobro1}}/{{$bills->nfra_cobro1}}</div>
                                        </div>
                                        <div class="factura_gastos">
                                            ...
                                            <div class="separador"></div>
                                             <div class="producto_resumen_info">
                                                 ...
                                                 <div><strong><span>{{$bills->imp_cobro1}}</span><span> €</span></strong></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
