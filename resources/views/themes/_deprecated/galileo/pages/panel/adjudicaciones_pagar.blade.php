...
$all_adj=array();
$tipo_pago_global = true; //cuando el tipo de pago es glogal o por subastas
            ...
            <div class="col-xs-12 col-md-9 col-lg-9 ">
                ...
                <div class="user-accounte-titles-link">
                    <ul class="ul-format d-flex justify-content-space-between flex-wrap" role="tablist">
                        <li role="pagar"class="active" ><a class="color-letter" href="{{ \Routing::slug('user/panel/allotments/outstanding') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.still_paid') }}</a></li>
                        <li role="pagadas"  ><a class="color-letter" href="{{ \Routing::slug('user/panel/allotments/paid') }}" >{{ trans(\Config::get('app.theme').'-app.user_panel.bills') }}</a></li>   
                    </ul>
                </div>
