...
<div class="account-user color-letter  panel-user">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 col-lg-9 account-user-data ">
            ...
            <div class="col-md-7 col-xs-12 no-padding ">
                ...
                <form method="post" class="frmLogin" id="frmUpdateUserInfoADV" data-toggle="validator">
                    ...
                    <div class="inputs-custom-group d-flex justify-content-space-between flex-wrap">
                        <div class="form-group-custom form-group col-xs-7 <?= count(Config::get('app.locales'))==1?'hidden':''; ?> ">
                    ...
                    @if($data['user']->fisjur_cli == 'J')
                        ...
                        <div class="form-group input-group name_client col-xs-12 col-sm-6">
                            ...
                            <input onkeypress="return noComa(event)" type="text" class="form-control"  placeholder="{{ trans(\Config::get('app.theme').'-app.login_register.contact') }}" type="text" name="usuario" value="{{$data['user']->nom_cli}}" required>
                    ...
                    @else
                        <div class="form-group input-group name_client col-xs-12 col-sm-6">
                            ...
                            <input  onkeypress="return noComa(event)" type="text" class="form-control" name="usuario" placeholder="{{ trans(\Config::get('app.theme').'-app.user_panel.name') }}" required value="<?= $name[1] ?>">
                            <input type="hidden" class="form-control" name="title_name" value="{{ trans(\Config::get('app.theme').'-app.user_panel.name') }}">

                        </div>
                        <div class="form-group input-group name_client col-xs-12 col-sm-6">
                            <label class="" for="apellido">{{ trans(\Config::get('app.theme').'-app.login_register.apellidos') }}</label>
                            <input class="form-control" onkeypress="return noComa(event)" id="apellido" name="last_name" placeholder="{{ trans(\Config::get('app.theme').'-app.login_register.apellidos') }}" required="" type="text" value="<?= $name[0] ?>">
                    ...
                    <div class="form-group form-group-custom col-xs-12 col-sm-7">
                    ...
                    <div class="form-group form-group-custom col-xs-12 col-sm-9">
                    ...
                    <div class="form-group input-group col-xs-12 col-sm-4 col-md-3">
                    ...
                    <div class="form-group input-group col-xs-12 col-sm-4 col-md-9">
    ...
    <form method="post" class="frmLogin" id="frmUpdateUserPasswordADV" data-toggle="validator">
                    <div class="inputs-custom-group d-flex justify-content-space-between flex-wrap">
                        ...
                        <div class="form-group input-group col-xs-12 col-sm-4 col-md-12">
                            ...
                            <input maxlength="20" type="current_password" name="last_password" type="password" class="form-control"  placeholder="{{ trans(\Config::get('app.theme').'-app.user_panel.pass') }}" data-minlength="4" required maxlength="8">
                        </div>
                        <br>
                        <div class="form-group input-group col-xs-12 col-sm-4 col-md-12" style="position: relative">
                            <label for="contrasena">{{ trans(\Config::get('app.theme').'-app.user_panel.new_pass') }}</label>
                            <input maxlength="20" type="password" id="password" name="password" type="password" class="form-control" id="contrasena" placeholder="{{ trans(\Config::get('app.theme').'-app.user_panel.new_pass') }}" data-minlength="5" required maxlength="8">
                        ...
                        <div class="form-group input-group col-xs-12 col-sm-4 col-md-12" style="position: relative">
                            ...
                            <input maxlength="20" type="password" name="confirm_password" class="form-control" data-match="#password" id="confirmcontrasena" placeholder="{{ trans(\Config::get('app.theme').'-app.user_panel.new_pass_repeat') }}" required >
                            <img role="button" class="view_password eye-password" src="data:image/png;base64,">
