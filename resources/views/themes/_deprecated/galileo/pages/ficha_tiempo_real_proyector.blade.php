                   ...
                   <div class="col-lg-11" style="border-right:0;">
                        ...
                        <div class="" id="main_lot_box" style="position:relative;">
                            <div id="main_image_box">
                                ...
                                <!-- INICIADA -->
                                <span id="lote_actual_main" class="pull-left">{{ trans(\Config::get('app.theme').'-app.sheet_tr.lot') }} <strong><span id="info_lot_actual">{{ $data['subasta_info']->lote_actual->ref_asigl0 }} </span></strong> <?php /*<span id="actual_titulo"></span>*/ ?> </span>
                                ...
                                <div class=" descripcion started hidden">
                                    ...
                                    <div id="actual_descripcion" style="overflow:hidden;height:230px;max-height:230px;font-size:25px">
