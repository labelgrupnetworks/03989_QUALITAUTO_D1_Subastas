            ...
            <div class="col-xs-12 col-md-7 contact-page-form">
                <form name="contactForm" id="contactForm" method="post" action="javascript:sendContact()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="check_term row">
                            <div class="col-xs-2 col-md-1">
                                <input type="checkbox" class="newsletter" name="condiciones2" value="on" id="bool__1__condiciones2" autocomplete="off">
                            </div>
                            <div class="col-xs-10 col-md-11">
