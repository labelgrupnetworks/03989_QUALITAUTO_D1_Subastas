                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="lots">
						<div class="row">
								...
								{!! \BannerLib::bannersPorKey('SUBASTA_'.$auction->cod_sub, 'banner_grid', ['dots' => false, 'arrows' => false]) !!}
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-12 fondo_sesiones">
									...
									$sesiones = App\Models\V5\AucSessions::select('"id_auc_sessions","auction","reference", "name", "start", "end", "init_lot", "end_lot"')->
									...
									@foreach($sesiones as $sesion)
										...
										$month = mb_strtoupper(date("M", strtotime($sesion->start)));
										$monthName = \Tools::get_month_lang($month, trans(\Config::get('app.theme')."-app.global.month_large"));
										$url=\Tools::url_auction($sesion->auction,$sesion->name,$sesion->id_auc_sessions,$sesion->reference);
										@endphp
