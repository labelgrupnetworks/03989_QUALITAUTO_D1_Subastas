    ...
    <nav class="menu-header">
        ...
        <div class="logo-header">
            <a title="{{(\Config::get( 'app.name' ))}}" href="/{{$lang}}">
                <img class="logo-company" src="/themes/{{\Config::get('app.theme')}}/assets/img/logo.jpg"  alt="{{(\Config::get( 'app.name' ))}}">
            </a>
        </div>
            ...
            <ul class="menu-principal-content d-flex justify-content-center align-items-center">
                ...
                ?>
                    ...
                    <li style="position: relative">
						<div class="arrow hidden-xs hidden-sm hidden-md"></div>
						<a class="color-letter flex-display link-header justify-center align-items-center" href="{{ \Routing::translateSeo('venta-directa') }}"><span>{{ trans(\Config::get('app.theme').'-app.foot.direct_sale')}}</span></a>
					</li>
...
<div class="header_categories">
	...
	<div class="d-flex align-items-center mb-2">
		<img style="margin-right: 5px" src="/themes/{{Config::get("app.theme")}}/assets/category/category_{{$category["lin_ortsec0"]}}.svg" alt="{{$category["des_ortsec0"]}}" width="25" height="auto">
		<strong>
