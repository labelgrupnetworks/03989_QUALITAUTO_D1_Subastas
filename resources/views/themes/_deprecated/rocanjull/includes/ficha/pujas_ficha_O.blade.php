...
<div id="reload_inf_lot" class="col-xs-12 info-ficha-buy-info no-padding">
		...
		<div class="info_single_title hist_new <?= !empty($data['js_item']['user']['ordenMaxima'])?'':'hidden'; ?> ">
			...
			<strong>
				<span id="tuorden">
					...
					@if ( !empty($lote_actual->max_puja) && $lote_actual->max_puja->cod_licit ==
	...
	<div class=" col-xs-12 no-padding info-ficha-buy-info-price d-flex info-ficha-prices">
		<div class="pre">
			...
			<p class="pre-price">{{$lote_actual->formatted_imptas_asigl0}}
		...
		<div class="pre">
			...
			<p class="pre-price">
				{{ !empty($lote_actual->formatted_impres_asigl0) ? $lote_actual->formatted_impres_asigl0 : 0 }}
				{{ trans(\Config::get('app.theme').'-app.subastas.euros') }} </p>
		</div>
	</div>
	...
	<div class=" col-xs-12 no-padding info-ficha-buy-info-price d-flex info-ficha-percents">
		<div class="pre">
			...
			<p class="pre-price">{{$lote_actual->comision}} {{ trans(\Config::get('app.theme').'-app.lot.percentage') }}
			</p>
		</div>
	</div>
