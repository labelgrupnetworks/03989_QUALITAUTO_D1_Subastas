                    ...
                    <div class="auctions-list col-xs-12">
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="border-right-light col-xs-12 col-md-8 h-100 no-padding">
                                ...
                                <div class="col-xs-12 @if($subasta->tipo_sub != 'V') col-sm-8 col-md-6 @endif no-padding auction-item-img">
                                    <div class="auction-size col-xs-12 no-padding mb-2" @if($subasta->tipo_sub == 'V') style="padding-left: 0px" @endif>
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-offset-0 col-md-4 d-flex justify-content-center h-100 align-items-center">
                                    <div class="auction-item-links w-100">
                                                <div class="auction-item-icon-desc d-block">
                                                    <a title="{{ $subasta->name }}" href="{{ $url_lotes }}" class=" btn-view-lots button-principal">
														@if($subasta->tipo_sub != 'V')
															{{ trans(\Config::get('app.theme').'-app.subastas.see_lotes') }}
														@else
															{{ trans(\Config::get('app.theme').'-app.sheet_tr.view') }}
														@endif
													</a>
                                                </div>
                                            <div class="auction-item-icon-desc  d-block">
                                            ...
                                            @if( $subasta->tipo_sub =='W' &&   strtotime($subasta->session_end) > time() )
                                                <div class="bid-life d-block">
                                                    <a  style="color:#FFFFFF" class="btn-bid-life d-block "  href="{{ $url_tiempo_real }}" title="{{ trans(\Config::get('app.theme').'-app.lot_list.from') }} {{ date_format(date_create_from_format('Y-m-d H:i:s',$subasta->session_start),'d/m/Y H:i') }} {{ trans(\Config::get('app.theme').'-app.lot_list.to') }} {{ date_format(date_create_from_format('Y-m-d H:i:s',$subasta->session_end),'d/m/Y H:i') }}" target="_blank">{{ trans(\Config::get('app.theme').'-app.lot.bid_live') }}</a>
                                                </div>
                                            @endif
