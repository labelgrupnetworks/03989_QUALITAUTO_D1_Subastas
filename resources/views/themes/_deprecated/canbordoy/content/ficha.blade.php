                    ...
                    <div class="minis-content d-flex flex-wrap">
                        ...
                        <div class="mini-img-ficha">
                                ...
                                <div id="360img-button" data-active="disabled"
                                    ...
                                    style="display:none; background-repeat: no-repeat;padding: 15px;background-position:center;background-size: contain;background-image: url('/img/load/lote_small<?php echo $lote_actual->imagenes[0]?>')">
