                                    ...
                                    <div class="tit_page">
                                        ...
                                        <div class="item-perfil">                
                                            <div class="input-group-custom">
                                                ...
                                                <div class="form-group input-group-addon-custom ">
                                                    <input class="form-control change_job" id="inlineCheckbox2" name="pri_emp" value="J" type="radio"> 
                                        ...
                                        <div class="genero">
                                                <div class="col-xs-3">                                    
                                                    <div class="input-group">
                                                        <div class="form-group input-gener">
                                                            <input class="form-control" style="" id="inlineRadio1" value="H" name="sexo" checked="checked" type="radio"> 
                                                ...
                                                <div class="col-xs-9">
                                                    <div class="input-group">
                                                        <div class="form-group input-gener">
                                                            <input class="form-control" style="" id="inlineRadio2" name="sexo" value="M" type="radio"> 
