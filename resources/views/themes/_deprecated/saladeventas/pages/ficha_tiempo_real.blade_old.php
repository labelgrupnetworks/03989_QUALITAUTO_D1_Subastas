...
<div class="">
    <div style="margin-top:20px; background:white">
            ...
            <div id="clock" style="display: block">
                                <div><img style="max-width: 100%; display: block; margin: 0 auto; margin-top: 100px; margin-bottom: 50px;" src="/themes/{{\Config::get('app.theme')}}/assets/img/logo-footer.png"  alt="{{(\Config::get( 'app.name' ))}}"></div>
