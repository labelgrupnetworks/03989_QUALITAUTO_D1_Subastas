			...
			<div class="col-xs-12 col-sm-10 col-md-10 hidden-xs">
				...
				<div class="img_single_border">
                                ...
                                @elseif($lote_actual->fac_hces1 == 'D' || $lote_actual->fac_hces1 == 'R')
                                    <div class="retired" style ="background:#606061;text-transform: lowercase;">
                                ...
                                @endif
					<div id="img_main" class="img_single" oncontextmenu="return false;">
                                            
                                            
						<a title="{{$lote_actual->titulo_hces1}}" href="javascript:action_fav_modal('remove')">
							<img src="/img/load/lote_large/{{ $lote_actual->imagen }}" alt="{{$lote_actual->titulo_hces1}}">
						</a>
