...
<div class="ficha-content color-letter">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-7 col-xs-12 no-padding" style="position: relative">
				<?php
		   ...
		   ?>
						...
						<div class="owl-theme owl-carousel visible-xs" id="owl-carousel-responsive">
							...
							<?php foreach($lote_actual->imagenes as $key => $imagen){?>
								   <div class="item_content_img_single" style="position: relative; height: 290px; overflow: hidden;">
										<img style="    max-width: 100%; top: 50%; transform: translateY(-50%); position: relative; display: inherit !important;    margin: 0 auto !important;" class="img-responsive" src="{{Tools::url_img('lote_medium_large',$lote_actual->num_hces1,$lote_actual->lin_hces1, $key)}}" alt="{{$lote_actual->titulo_hces1}}" alt="{{$lote_actual->descweb_hces1}}">
								   </div>
							 <?php } ?>
						</div>
				...
				<div class="col-xs-12 no-padding hidden-xs">
					...
					<div id="img_main" class="img_single">
							<a title="{{$lote_actual->descweb_hces1}}" href="javascript:action_fav_modal('remove')">
							<img class="img-responsive" src="{{Tools::url_img('lote_large',$lote_actual->num_hces1,$lote_actual->lin_hces1)}}" alt="{!!$lote_actual->descweb_hces1!!}">
							</a>
						</div>
						...
						<?php foreach($lote_actual->imagenes as $key => $imagen){?>
							<div   class="mini-img-ficha no-360">
								...
								<a href="javascript:loadSeaDragon('<?=$imagen?>');">
									<div class="img-openDragon" style="background-image:url('{{ \Tools::url_img("lote_small", $lote_actual->num_hces1, $lote_actual->lin_hces1, $key) }}'); background-size: contain; background-position: center; background-repeat: no-repeat;" alt="{{$lote_actual->descweb_hces1}}"></div>
	...
	<div class="col-sm-5 col-xs-12 no-padding content-right-ficha d-flex justify-content-space-between flex-column">
...
<div class="container ficha-desc no-padding">

	<h3>{{ trans(\Config::get('app.theme').'-app.lot.description') }}</h3>
	<br>

        <big><?= strip_tags($lote_actual->descweb_hces1) ?>.</big><br>

	<big>{!! ($lote_actual->desc_hces1) !!}</big>

	<br><br><br><br>

	<h3>{{ trans(\Config::get('app.theme').'-app.lot.recommended_lots') }}</h3>
	<br>
