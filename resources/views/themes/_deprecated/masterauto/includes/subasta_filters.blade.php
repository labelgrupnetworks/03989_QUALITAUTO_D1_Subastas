<div class="filters-auction-content">
        ...
        <div class="form-group">
            ...
            <div class="filters-auction-texts">
                ...
                <label class="filters-auction-label hidden" for="input_reference">{{ trans(\Config::get('app.theme').'-app.lot_list.reference') }}</label>
                <input id="input_reference" placeholder="{{ trans(\Config::get('app.theme').'-app.lot_list.reference') }}" name="reference" type="text" class="form-control input-sm filter-auction-input hidden" value="{{ app('request')->input('reference') }}">
            </div>
