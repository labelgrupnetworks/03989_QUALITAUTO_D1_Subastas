	...
	<div class="container">
		<div class="row flex-display row-custom">
			...
			<div
				...
				{!! \BannerLib::bannersPorKey('home_banner', 'home-top-banner') !!}
			</div>
...
<br><br>
{!! \BannerLib::bannersPorKey('banner_numeros', 'home-numeros-banner', "{dots:false,autoplay: true, autoplaySpeed: 5000,
slidesToScroll:1}") !!}

<br><br>

<div class="center-button">
	<a class="button-principal howtobuy" title="{{ trans(\Config::get('app.theme').'-app.foot.how_work?') }}"
		href="{{ Routing::translateSeo('pagina').trans(\Config::get('app.theme').'-app.links.how_to_buy') }}">{{ trans(\Config::get('app.theme').'-app.foot.how_work?') }}</a>
</div>
...
<br>
{!! \BannerLib::bannersPorKey('map_banner', 'home-map-banner', "{dots:false,autoplay: true, autoplaySpeed: 5000, slidesToScroll:1}") !!}
