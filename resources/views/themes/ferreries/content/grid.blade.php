                    ...
                    <div role="tabpanel" class="tab-pane active" id="lots">
						<div class="row">
							...
							<div class="col-xs-12 col-md-9 p-0">
								...
								<div class="col-xs-12 text-center mt-2 mb-2" style="color: #001638;font-size: 18px;font-weight: bold;">
									Todos los lotes han sido cedidos para esta subasta por sus  respectivos propietarios, agentes o clubes a los que pertenecen
								</div>
