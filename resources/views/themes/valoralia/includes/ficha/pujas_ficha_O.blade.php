				...
				<div class="input-group d-block group-pujar-custom ">
					...
					<div class="d-flex mb-2">
						...
						<div class="input-group-btn">
							...
							@else
								<button type="button" data-from="modal" class="lot-action_pujar_on_line ficha-btn-bid ficha-btn-bid-height button-principal {{ Session::has('user') ? 'add_favs' : '' }}" ref="{{ $lote_actual->ref_asigl0 }}" codsub="{{ $lote_actual->cod_sub }}" >
									{{ trans(\Config::get('app.theme').'-app.lot.pujar') }}
								</button>
							@endif
						</div>
