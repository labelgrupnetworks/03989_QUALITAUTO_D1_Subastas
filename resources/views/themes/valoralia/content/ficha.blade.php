       ...
       <div class="d-flex  flex-column">
            <div class="ficha-info-title col-xs-12 no-padding">
					...
					{{-- <div class="init-time-container">
                        <p class="time-text d-inline-block">{{ trans(\Config::get('app.theme') . '-app.lot.start_date') }}</p>
                        <p class="time-value d-inline-block"
                            data-date="{{ $subasta_web ? $lote_actual->orders_start : $lote_actual->start_session }}">
                        </p>
                    </div>
                    <div class="finish-time-container">
                        <p class="time-text d-inline-block">{{ trans(\Config::get('app.theme') . '-app.lot.end_date') }}</p>
                        <p class="time-value d-inline-block"
                ...
                <div class="ficha-info-items">
                    ...
                    ?>
						...
						@elseif($lote_actual->tipo_sub === "E")
							@include('includes.ficha.pujas_ficha_E')
			...
			<div class="row">
				<div class="col-xs-12 mt-3 mb-3">
					...
					<div class="desc-lot-title">
						<p class="desc-lot-profile-title">Documentos</p>
					</div>
