...
<section class="subnav d-none d-xxl-block">
	<div class="container header-brand">
		<a class="navbar-brand" href="/{{$lang}}" title="{{(\Config::get( 'app.name' ))}}">
			<img width="200" class="img-responsive" src="/themes/{{$theme}}/assets/img/foto_logo_transp.png"  alt="{{(\Config::get( 'app.name' ))}}">
		</a>
		<a class="navbar-brand" href="/{{$lang}}" title="{{(\Config::get( 'app.name' ))}}">
			<img width="300" class="img-responsive logo-brand" src="/themes/{{$theme}}/assets/img/logo.png"  alt="{{(\Config::get( 'app.name' ))}}">
		</a>
	</div>
</section>
