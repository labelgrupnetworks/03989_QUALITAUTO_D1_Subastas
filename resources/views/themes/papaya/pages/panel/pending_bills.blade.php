        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9 col-lg-9 ">
                    ...
                    <div class="col-xs-12 no-padding panel-collapse in" id="collapse_pays"  data-toggle="collapse" aria-expanded="true">
                        ...
                        <form id="pagar_fact"> 
                            ...
                            @foreach($data['pending'] as $key_bill => $pendiente)
                             <div class="factura col-md-12 d-flex" data-anum="{{$pendiente->anum_pcob}}" data-num="{{$pendiente->num_pcob}}">
                                <div class="factura_check" style="position: relative">
                                    <label for="checkFactura-{{$pendiente->anum_pcob}}-{{$pendiente->num_pcob}}">
                                        <input name="factura[{{$pendiente->anum_pcob}}][{{$pendiente->num_pcob}}]" id="checkFactura-{{$pendiente->anum_pcob}}-{{$pendiente->num_pcob}}" type="checkbox" class="hide add_factura" checked>
                                        <span class="checkmark"></span>
        
                                    </label>
                                </div>
                                <div class="factura_box d-flex flex-wrap justify-content-center align-items-center col-xs-12 col-md-12">
                                    <div class="visible-md visible-lg factura_icon col-xs-6 col-md-2">
                                        ...
                                        @endif                                    </div>
                                    <div class="factura_datos col-xs-6 col-md-3">
                    ...
                    <div class="user-accounte-titles-link col-xs-12 no-padding">
                            <ul class="ul-format d-flex justify-content-space-between align-items-center" style="text-transform: uppercase" role="tablist"  role="button" data-toggle="collapse" href="#collapse_bills" aria-expanded="false" aria-controls="collapse_bills">
                                    <li role="pagadas"  ><a class="color-letter" href="{{ \Routing::slug('user/panel/myBills') }}" style="text-transform: uppercase">{{ trans(\Config::get('app.theme').'-app.user_panel.bills') }}</a></li>   
                                    <span>
                        ...
                        <div class="col-xs-12 no-padding panel-collapse collapse" id="collapse_pays"  data-toggle="collapse" aria-expanded="false">
                                <div class="col-xs-12" style="padding-left:39px;">
                                    <div class="user-account-heading hidden-xs d-flex align-items-center justify-content-space-between">
                                            <div class="col-xs-12 col-sm-7 col-lg-8 col-one user-account-item">
                                                    {{ trans(\Config::get('app.theme').'-app.user_panel.lot') }}
