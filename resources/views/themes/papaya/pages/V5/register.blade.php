			...
			<div class="col-xs-12 general-container">
				...
				<div class="create-account-title d-flex justify-content-center">
					...
					<div class="row">
						...
						<div class="col-xs-11">
							<label for="bool__1__condicionesSubalia">{{ trans(\Config::get('app.theme').'-app.login_register.read_conditions_subalia') }} (<a " target="_blank">{{ trans(\Config::get('app.theme').'-app.login_register.more_info') }}</a>)
								</label>
