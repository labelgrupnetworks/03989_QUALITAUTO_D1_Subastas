                ...
                <div class="col-xs-12 col-sm-5 info-auction-info">
                    <div class="info-auction-info-content">
                        <div class="info-auction-info-title">
                                ...
                                <p style="text-align: justify"><?= empty($data["auction"]->descdet_sub)? ' ' : $data["auction"]->descdet_sub; ?></p>
                        </div>
                        <div class="info-auction-info-address">
                                ...
                                @if(!empty($data["auction"]->expomaps_sub))
                                    <p class="how_to_get_content"><a target="_blank" class="color-letter how_to_get" title="cómo llegar" href="https://maps.google.com/?q=<?= $data['auction']->expomaps_sub ?>"><i class="fa fa-map-marker-alt" style="font-size: 17px;"></i></a></p>
                                @endif
                            ...
                            @if(!empty($data["auction"]->sesmaps_sub))
                                <p class="how_to_get_content"><a target="_blank" class="color-letter how_to_get" title="{{ trans(\Config::get('app.theme').'-app.subastas.how_to_get') }}" href="https://maps.google.com/?q=<?= $data['auction']->sesmaps_sub ?>"><i class="fa fa-map-marker-alt" style="font-size: 17px;"></i></a></p>
                            @endif
