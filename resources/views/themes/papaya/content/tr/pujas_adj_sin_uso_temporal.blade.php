    ...
    @if (\Config::get('app.tr_show_pujas'))
    	<div class="col-lg-6">
    		...
    		<div class="aside pujas">
    			...
    			<h2>{{ trans(\Config::get('app.theme').'-app.sheet_tr.bids') }}</h2>

    			<?php foreach ($data['subasta_info']->lote_actual->pujas as $puja) : ?>
                    <div class="pujas_model">
    					<div class="col-lg-6 tipoPuja">
    						<p data-type="I" @if ($puja->pujrep_asigl1 != 'W')class="hidden" @endif ><i class="fa fa-globe" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-web') }}</p>
                            ...
                            <p data-type="E" @if ($puja->pujrep_asigl1 != 'E')class="hidden" @endif><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-erp') }}</p>
                            <p data-type="W" @if ($puja->pujrep_asigl1 != 'E')class="hidden" @endif><i class="fa fa-wikipedia-w" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-erp') }}</p>
    					</div>
                ...
                <div class="pujas_model hidden" id="type_bid_model">
                    <div class="col-lg-6 tipoPuja">
                        <p data-type="I"><i class="fa fa-globe" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-web') }}</p>
                        ...
                        <p data-type="E" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-erp') }}</p>
                        <p data-type="W" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.bid-erp') }}</p>
                    </div>
                    <div class="col-lg-6 importePuja">
                        <p>
