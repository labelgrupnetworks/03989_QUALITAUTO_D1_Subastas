<div class="form-authorize">
    ...
    <div class="row">
        <div class="col-xs-12">
            <input id="files" name="files[]" type="file" class="file form-control" data-show-upload="false"
                data-show-caption="true" multiple>
            <p class="text-left"><small>{{ trans(\Config::get('app.theme') . '-app.lot.upload_document_size') }}</small>
            </p>
        </div>
    </div>
