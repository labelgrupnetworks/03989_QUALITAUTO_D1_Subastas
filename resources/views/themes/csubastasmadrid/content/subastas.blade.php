						...
						{{-- <div class="col-xs-12 col-sm-4 col-lg-3">
							<div class="item_subasta">
								...
								@if ($subasta->upcatalogo == 'S')
									<p class="text-center">
										<a class="btn btn-subasta" title="{{ trans(\Config::get('app.theme') . '-app.grid.pdf_catalog') }}"
											target="_blank"
								...
								@if ($subasta->uppreciorealizado == 'S')
									<p class="text-center">
										<a class="btn btn-subasta" title="{{ trans(\Config::get('app.theme') . '-app.grid.pdf_adj') }}"
											target="_blank"
