    ...
    <div class="row" style="margin-top:20px;">
        <div class="col-lg-12">
            <div class="panel panel-primary">
				...
				<ul class="nav nav-tabs customs-tabs">
					<li @if(!config('app.use_credit')) class="active" @endif>
						<div class="panel-heading">
							<a data-toggle="tab" href="#mensajes"><h2 class="msj">{{ trans(\Config::get('app.theme').'-app.sheet_tr.room_msg') }} ({{ strtoupper(\App::getLocale()) }})</h2></a>

						</div>
					</li>
					@if(config('app.use_credit'))
					<li class="active">
						<div class="panel-heading">
							<a data-toggle="tab" href="#credito"><h2 class="msj">{{ trans(\Config::get('app.theme').'-app.sheet_tr.credit') }}</h2></a>
						</div>
					</li>
					@endif
				</ul>
			...
			<div class="tab-content">
				...
				<div id="mensajes" class="tab-pane fade @if(!config('app.use_credit')) in active @endif">
				...
				<div id="credito" class="tab-pane fade in active">
					@include('content.tr.tiempo_real_admin.credito_usuarios')
				</div>
				@endif
