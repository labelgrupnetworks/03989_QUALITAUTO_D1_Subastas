...
function timer(){
    var goog_temp = $.cookie('googtrans');
    if(goog_temp != goog){
        @if($data['data']->key_web_page == 'como-vender')
...
function change_video_vender(goog){
    ...
    if(goog && goog != '/es/es'){
        if(goog == '/es/ca'){
            $("video").attr('src','/themes/{{$theme}}/assets/como_vender_CA.mp4')
        }else{
            $("video").attr('src','/themes/{{$theme}}/assets/como_vender_EN.mp4')
        }
    }else{
        $("video").attr('src','/themes/{{$theme}}/assets/como_vender_ES.mp4')
    }
...
function change_video_comprar(goog){
    if(goog && goog != '/es/es'){
        if(goog == '/es/ca'){
            $("video").attr('src','/themes/{{$theme}}/assets/como_comprar_CA.mp4')
        }else{
            $("video").attr('src','/themes/{{$theme}}/assets/como_comprar_EN.mp4')
        }
    }else{
        $("video").attr('src','/themes/{{$theme}}/assets/como_comprar_ES.mp4')
    }
}
</script>
@endif
