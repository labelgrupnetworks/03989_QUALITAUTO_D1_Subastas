...
<?php
$families = array();
$families[1] = trans(\Config::get('app.theme').'-app.foot.sellos_españa');
$families[2] = trans(\Config::get('app.theme').'-app.foot.sellos');
$families[3] = trans(\Config::get('app.theme').'-app.foot.libros_documentos');
$families[4] = trans(\Config::get('app.theme').'-app.foot.carteles');
$families[5] = trans(\Config::get('app.theme').'-app.foot.monedas_billetes');
$families[6] = trans(\Config::get('app.theme').'-app.foot.coleccionismo');
?>
					...
					<div class="well">
						...
						<div class="clearfix"></div>
                                                ...
                                                <div class="datos_newsletter">
                                                    ...
                                                    <p class="newsletter-title"><big>{{ trans(\Config::get('app.theme').'-app.login_register.recibir_newsletter') }}</big></p>
                                                    <br>
                        ...
                        <div class="datos_condiciones">
							...
							<div class="checkbox-container condiciones col-xs-12 p-0">
