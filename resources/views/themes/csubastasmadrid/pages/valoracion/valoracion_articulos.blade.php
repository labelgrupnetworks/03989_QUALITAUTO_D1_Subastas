	...
	<div class="container" id="return-valoracion">
			...
			<label for="recibir-newletter" class="condiciones">
                               <?= trans(\Config::get('app.theme').'-app.login_register.read_conditions_politic') ?>
                                               ...
                                               <div style="margin-top: 20px;" id="recaptcha" data-callback="recaptcha_callback" class="g-recaptcha" data-sitekey="6LdhD34UAAAAANG9lkke6_b6fyycAsWTpfpm_sTV"></div>

                   <div clas="row" >
                       <div class="col-md-12">

                           <br>
                            <button type="submit" id="valoracion-adv" class="btn-valoracion  btn btn-primary btn-color"><div class='loader hidden'  style="height: 10px;width: 10px;margin-top: 0px;margin-bottom: 9px;"></div>{{ trans(\Config::get('app.theme').'-app.valoracion_gratuita.send') }}</button>
                            <br><br>
