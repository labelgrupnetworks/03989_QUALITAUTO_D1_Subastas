    ...
    <div id="pujas_list">
        ...
        foreach ($data['subasta_info']->lote_actual->pujas as $puja) :
            ...
            <div class="pujas_model col-xs-12">
                <div class="col-xs-7 tipoPuja">
					...
					<p data-type="R" @if ($puja->pujrep_asigl1 != 'R')class="hidden" @endif><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.books_bid') }}</p>
        ...
        <div class="pujas_model hidden col-xs-12" id="type_bid_model">
            <div class="col-xs-7 tipoPuja">
				...
				<p data-type="R" class="hidden"><i class="fa fa-desktop" aria-hidden="true"></i> {{ trans(\Config::get('app.theme').'-app.sheet_tr.books_bid') }}</p>
