               ...
               <div class="row">
                ...
                <div class="col-lg-6">
					...
					@endif
                        ...
                        {{ trans(\Config::get('app.theme').'-app.sheet_tr.start_price') }}:  <span>{{ $data['js_item']['subasta']['currency']->symbol }}</span><span class="precio">{{ \Tools::moneyFormat($data['subasta_info']->lote_siguiente->impsalhces_asigl0) }}</span>
