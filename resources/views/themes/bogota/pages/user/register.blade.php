					...
					<div class="well">
						...
						<br>
							...
							<div class="datos_right">
								...
								{!!  str_replace("__1__","__0__",$formulario->fecha_nacimiento)!!}
							</div>
							<div class="datos_left">
							...
							<div class="datos_right">
								...
								{!!  str_replace("__0__","__1__",$formulario->cif)!!}
							</div>
							...
							<div class="datos_right">
								...
								{{-- Hacemos que n osea obligatorio--}}
								{!!  str_replace("__1__","__0__",$formulario->cpostal) !!}
							</div>
							...
							<div class="datos_left">
								...
								{{-- Hacemos que n osea obligatorio--}}
								{!! str_replace("__1__","__0__", $formulario->poblacion) !!}
							</div>
							<div class="datos_right">
								<label>{{ trans(\Config::get('app.theme').'-app.login_register.provincia') }}</label>
								{{-- Hacemos que n osea obligatorio--}}
								{!! str_replace("__1__","__0__",$formulario->provincia) !!}
							</div>
							<div class="datos_left">
						...
						<div class="clearfix"></div>
                                                ...
                                                <div class="datos_newsletter">
                                                    ...
                                                    <div class="checkbox-container col-xs-12">
                                                        ...
                                                        <label for="bool__0__condiciones">
                        ...
                        <div class=" datos_condiciones ">
							...
							<div class="checkbox-container condiciones col-xs-12 ">
								...
								<label for="bool__1__condiciones">{!! trans(\Config::get('app.theme').'-app.login_register.read_conditions') !!} (<a href="<?php echo Routing::translateSeo('pagina') . trans(\Config::get('app.theme') . '-app.links.term_condition') ?>" target="_blank">{{ trans(\Config::get('app.theme').'-app.login_register.more_info') }}</a>)
									...
									<div class="mt-1">
									<span><input type="checkbox"  value="on" id="bool__1__condiciones_2" autocomplete="off" data-placement="bottom"></span>
									<label for="bool__1__condiciones_2" style="display: inline;">{!! trans(\Config::get('app.theme').'-app.login_register.read_conditions_2') !!}</label>
									</div><div class="mt-1">
									<span><input type="checkbox"  value="on" id="bool__1__condiciones_3" autocomplete="off" data-placement="bottom"></span>
									<label for="bool__1__condiciones_3"  style="display: inline;">{!! trans(\Config::get('app.theme').'-app.login_register.read_conditions_3') !!}</label>
									</div><div class="mt-1">
									<span><input type="checkbox"  value="on" id="bool__1__condiciones_4" autocomplete="off" data-placement="bottom"></span>
									<label for="bool__1__condiciones_4"  style="display: inline;">{!! trans(\Config::get('app.theme').'-app.login_register.read_conditions_4') !!}</label>
									</div>
								</div>
							<br>
