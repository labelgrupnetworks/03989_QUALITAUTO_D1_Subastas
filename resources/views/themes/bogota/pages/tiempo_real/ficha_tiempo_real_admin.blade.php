    ...
    <div style="margin-top:20px; background:white" class="global-content">
            ...
            <div id="clock" style="display: block">
                ...
                <div style="margin-top: 50px">
                    <img style="display: block;max-width: 300px; margin: 0 auto" src="/themes/{{\Config::get('app.theme')}}/img/logo.png"  alt="{{(\Config::get( 'app.name' ))}}">
                </div>
					...
					<div class="col-lg-6" style="border-left:0;">
						...
						<span id="lote_actual_main" class=""
								style="display:block">{{ trans(\Config::get('app.theme').'-app.sheet_tr.lot') }} <strong><span
										id="info_lot_actual">{{ $data['subasta_info']->lote_actual->ref_asigl0 }}</span></strong> </span>

						<div class="scrollable">


								@if(!empty($data['text_lang'][$data['js_item']['lang_code']]->titulo_hces1))
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="gestor_radios">
														<label class="radio">
                                                            <input checked="checked" type="radio"  name="puja_opts" value="firme"> {{ trans(\Config::get('app.theme').'-app.sheet_tr.direct_bid') }}
                                                        </label>
                                                        <label class="radio">
															{{-- IMPORTANTE, he cambiado el value de "puja" a "Pujanormal" para que no la marque como checked cada vez que hace una puja en firme, bogota por defecto hará las pujas en firme --}}
                                                            <input  type="radio" name="puja_opts" value="Pujanormal"> {{ trans(\Config::get('app.theme').'-app.sheet_tr.order_bid') }}
                                                        </label>
