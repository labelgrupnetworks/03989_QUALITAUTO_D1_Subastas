												...
												<div class="col-xs-12 col-sm-2 col-lg-2 account-item-border">
													<div class="user-account-item-price d-flex align-items-center">
														...
														<div @if (!empty($inf_lot->pujas[0]) &&
															...
															class="other"
															@endif
															><?= empty($inf_lot->pujas[0]->formatted_imp_asigl1)? '-':  trans(\Config::get('app.theme').'-app.subastas.euros')." ".$inf_lot->pujas[0]->formatted_imp_asigl1 ; ?>
														</div>
													</div>
												</div>
									...
									<table class="table table-striped table-custom">
										...
										<tbody>
											...
											<tr class='{{$inf_lot->ref_asigl0}}-{{$inf_lot->cod_sub}}'>
												...
												<td><?= empty($inf_lot->pujas->formatted_imp_asigl1)? '-': trans(\Config::get('app.theme').'-app.subastas.euros')." ".$inf_lot->pujas->formatted_imp_asigl1 ; ?>
												</td>
