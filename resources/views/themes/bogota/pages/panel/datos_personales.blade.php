                    	...
                    	<div class="inputs-custom-group d-flex justify-content-space-between flex-wrap">
							...
							@else
								<div class="form-group input-group name_client col-xs-12 col-sm-8">
									...
									<input type="text" class="form-control" name="usuario" placeholder="{{ trans(\Config::get('app.theme').'-app.user_panel.name') }}" required value="{{$name}}">
							...
							<div class="form-group input-group col-xs-12 col-sm-4 col-md-5">
								...
								<input name="provincia" class="form-control" placeholder="{{ trans(\Config::get('app.theme').'-app.login_register.provincia') }}" maxlength="30" type="text" value="{{$data['user']->pro_cli}}"/>
