                                    ...
                                    <div class="modal-wrapper">
                                            <div class=" text-center single_item_content">
                                                ...
                                                <span for="bid" class='desc_auc'>{{trans(\Config::get('app.theme').'-app.lot.bidding_for')}} </span>
												 	<strong>{{ trans(\Config::get('app.theme').'-app.lot.eur') }}<span class="precio_orden"></span></strong>
...
<!--<div id="price_min_surpass" class="info hidden"><div class="col-xs-12 ">{{ trans(\Config::get('app.theme').'-app.lot.minimal-price') }} <strong> {{$lote_actual->impres_asigl0}} </strong></div></div>-->
