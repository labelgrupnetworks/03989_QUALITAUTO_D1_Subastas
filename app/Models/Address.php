...
class Address extends Model
{
	...
	public function addDirEnvio($envio, $num, $user)
	{
        ...
        DB::select("INSERT INTO FXCLID
                (GEMP_CLID, CLI_CLID, CODD_CLID, NOMD_CLID,TIPO_CLID,CP_CLID,DIR_CLID,DIR2_CLID,POB_CLID,PAIS_CLID,CODPAIS_CLID,SG_CLID,PRO_CLID,TEL1_CLID,RSOC_CLID, CLI2_CLID, EMAIL_CLID, PREFTEL_CLID, RSOC2_CLID, MATER_CLID)
                VALUES
                (:emp,:num,:max_direcc,:usuario,'E',:cpostal,:direccion,:direccion2,:poblacion,:pais,:cod_pais,:via,:provincia,:telf,:rsoc, :cod2, :email, :preftel_clid, :rsoc2_clid, :mater_clid)",
                 array(
