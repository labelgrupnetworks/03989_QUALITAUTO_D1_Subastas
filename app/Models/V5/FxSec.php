...
class FxSec extends Model
{
	...
	public function scopeJoinFgOrtsecFxSec($query, $withOrtsec0 = false)
	{
		$emp = Config::get("app.emp");
		return $query->leftjoin("FGORTSEC1", "FGORTSEC1.SEC_ORTSEC1 = FXSEC.COD_SEC")
			->where("FGORTSEC1.EMP_ORTSEC1", $emp)
			->when($withOrtsec0, function ($query) {
				return $query->joinFgOrtsec0FxSec();
			});
	}

	public function scopeJoinFgOrtsec0FxSec($query)
	{
		return $query->join('fgortsec0', 'fgortsec0.sub_ortsec0 = fgortsec1.sub_ortsec1 and fgortsec0.emp_ortsec0 = fgortsec1.emp_ortsec1 and fgortsec0.lin_ortsec0 = fgortsec1.lin_ortsec1');
	}
