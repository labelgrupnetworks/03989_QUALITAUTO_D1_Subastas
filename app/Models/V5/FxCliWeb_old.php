...
class FxCliWeb extends Model
{
	...
	protected $primaryKey = 'EMP_CLIWEB, USRW_CLIWEB';
    ...
    static function loginUserCliweb($cod_cli) {
        ...
        $user['clicli'] = array();
        $clicli = FxCliCli::where("GEMP_CLICLI",\Config::get("app.gemp"))
