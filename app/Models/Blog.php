...
class Blog extends Model
{
   ...
   public function InsertBlog(){
       DB::table('WEB_BLOG')->insert([
            'id_web_blog' => $this->idblog_lang,
               'title_web_blog'=>$this->title,'img_web_blog'=>$this->img,'lot_categories_web_blog'=>$this->categories_web,'primary_category_web_blog'=>$this->category_principal,
                'lot_sub_categories_web_blog'=>$this->sub_categories_web,'publication_date_web_blog'=>$this->date,'emp_web_blog'=>Config::get('app.main_emp')]
        );
   }
   ...
   public function InsertBlogLang(){
       DB::table('WEB_BLOG_LANG')->insert(
            ['id_web_blog_lang'=>$this->id_lang,'idblog_web_blog_lang' => $this->idblog_lang,'ENABLED_WEB_BLOG_LANG'=>$this->enabled_blog,
                'lang_web_blog_lang'=>$this->lang,'titulo_web_blog_lang'=>$this->title_blog,'cita_web_blog_lang'=>$this->cita_blog,'texto_web_blog_lang'=>$this->cont_blog,
                'metatitle_web_blog_lang'=>$this->metatit_blog,'metadescription_web_blog_lang'=>$this->metades_blog,'url_web_blog_lang'=>$this->url_blog,'video_web_blog_lang'=>$this->video_blog]
        );
   }
   ...
   public function UpdateBlogLang(){
        DB::table('WEB_BLOG_LANG')
            ...
            ->update([
            'titulo_web_blog_lang'=>$this->title_blog,'cita_web_blog_lang'=>$this->cita_blog,'texto_web_blog_lang'=>$this->cont_blog,'enabled_web_blog_lang'=>$this->enabled_blog,
                'metatitle_web_blog_lang'=>$this->metatit_blog,'metadescription_web_blog_lang'=>$this->metades_blog,'url_web_blog_lang'=>$this->url_blog,'video_web_blog_lang'=>$this->video_blog
        ]);
   }
   ...
   public function getAllNoticiasLangByIdCategory($id_category_blog){
	...
	$blog = DB::table('WEB_BLOG')
			 ...
			 ->when($id_category_blog, function($q) use( $id_category_blog, $lang){
					 return $q->addSelect('WEB_CATEGORY_BLOG_LANG.*')
							 ->join('WEB_BLOG_REL_CATEGORY', 'WEB_BLOG_REL_CATEGORY.IDBLOG_WEB_BLOG_REL_CATEGORY', '=', 'WEB_BLOG.ID_WEB_BLOG')
					 ->join('WEB_CATEGORY_BLOG','WEB_CATEGORY_BLOG.ID_CATEGORY_BLOG','=','WEB_BLOG_REL_CATEGORY.IDCAT_WEB_BLOG_REL_CATEGORY')
					 ->join('WEB_CATEGORY_BLOG_LANG','WEB_CATEGORY_BLOG_LANG.ID_CATEGORY_BLOG_LANG','=','WEB_CATEGORY_BLOG.ID_CATEGORY_BLOG')
...
class CategorysBlog extends Model
{
   ...
   public function UpdateCategoryBlogLang(){
       DB::table('WEB_CATEGORY_BLOG_LANG')
            ...
            ->update(['title_category_blog_lang' => $this->title_category,'name_category_blog_lang'=>$this->name_category,'url_category_blog_lang' => $this->url_category,'metatit_category_blog_lang' => $this->metatit_category,
                'metades_category_blog_lang' => $this->metades_category,'metacont_category_blog_lang' => $this->metacont_category]);
   }

    public function InsertCategoryBlogLang(){
       DB::table('WEB_CATEGORY_BLOG_LANG')->insert([
            'id_category_blog_lang' => $this->id, 'lang_category_blog_lang' => $this->lang,
                'title_category_blog_lang' => $this->title_category,'name_category_blog_lang'=>$this->name_category,'url_category_blog_lang' => $this->url_category,'metatit_category_blog_lang' => $this->metatit_category,
                'metades_category_blog_lang' => $this->metades_category,'metacont_category_blog_lang' => $this->metacont_category
        ]);
   }
