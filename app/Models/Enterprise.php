...
class Enterprise {
    ...
    public function infEspecialistas(){
         ...
         $sql = "select ESP1.LIN_ESPECIAL1, ESP1.NOM_ESPECIAL1, ESP1.ORDEN_ESPECIAL1, ESP1.EMAIL_ESPECIAL1, NVL(ESP1_LANG.DESC_ESPECIAL1_LANG, ESP1.DESC_ESPECIAL1) DESC_ESPECIAL1,
