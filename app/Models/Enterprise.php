...
class Enterprise {
    ...
    public function infEspecialistas(){
         ...
         $sql = "select ESP1.*, NVL(ESPI0_LANG.TITULO_ESPECIAL0_LANG,  ESP0.TITULO_ESPECIAL0) TITULO_ESPECIAL0 from FGESPECIAL0 ESP0
                ...
                WHERE ESP0.EMP_ESPECIAL0 = :emp order by ESP0.ORDEN_ESPECIAL0";
