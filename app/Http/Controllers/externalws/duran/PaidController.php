...
class PaidController extends DuranController
{
	...
	private function merchantInfo( $merchantID){
		...
		$pedido = FgCsub0::select("COD_CLI, COD2_CLI, HIMP_CSUB, BASE_CSUB, IMP_CSUB0, IMPGAS_CSUB0, TAX_CSUB0, EXTRAINF_CSUB0, TIPO_SUB, IDORIGEN_ASIGL0, ALM_HCES1, COML_HCES1, DESCWEB_HCES1, DES_ALM, DIR_ALM, PERMISOEXP_HCES1 ")->
