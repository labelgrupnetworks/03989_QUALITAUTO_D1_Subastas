...
class LotController extends ApiLabelController
{
	...
	protected $asigl0Rename = [
		"idorigin" => "idorigen_asigl0",
		"idauction" => "sub_asigl0",
		"reflot" => "ref_asigl0",
		"close" => "cerrado_asigl0",
		"highlight" => "destacado_asigl0",
		"buyoption" => "compra_asigl0",
		"soldprice" => "remate_asigl0",
		"startprice" => "impsalhces_asigl0",
		"lowprice" => "imptas_asigl0",
		"highprice" => "imptash_asigl0",
		"reserveprice" => "impres_asigl0",
		"retired" => "retirado_asigl0",
		"hidden" => "oculto_asigl0",
		"disclaimed" => "desadju_asigl0",
		"startdate" => "fini_asigl0",
		"enddate" => "ffin_asigl0",
		"starthour" => "hini_asigl0",
		"endhour" => "hfin_asigl0",
		"ownercommission" => "comphces_asigl0",
		"biddercommission" => "comlhces_asigl0",
		"enddateoriginal" => "ffin_original_asigl0",
		"endhouroriginal" => "hfin_original_asigl0",
		"label" => "oferta_asigl0",
		"createdate" => "fecalta_asigl0",
		"priceweb" => "impsalweb_asigl0"
	];

	protected $hces1Rename = [
		"idorigin" => "idorigen_hces1",
		"idauction" => "sub_hces1",
		"reflot" => "ref_hces1",
		"idsubcategory" => "sec_hces1",
		"title" => "descweb_hces1",
		"description" => "desc_hces1",
		"extrainfo" => "descdet_hces1",
		"htmlcontent" => "contextra_hces1",
		"search" => "search_hces1",
		"startprice" => "impsal_hces1",
		"lowprice" => "imptasini_hces1",
		"highprice" => "imptash_hces1",
		"reserveprice" => "impres_hces1",
		"costprice" => "pc_hces1",
		"biddercommission" => "coml_hces1",
		"biddercommissionini" => "comlini_hces1",
		"ownercommission" => "comp_hces1",
		"ownercommissionini" => "compini_hces1",
		"warehouse" => "alm_hces1",
		"numberobjects" => "nobj_hces1",
		"high" => "alto_hces1",
		"width" => "ancho_hces1",
		"diameter" => "diam_hces1",
		"thickness" => "grueso_hces1",
		"weight" => "peso_hces1",
		"volumetricweight" => "pesovol_hces1",
		"video" => "img360_hces1",
		"ministry" => "ministerio_hces1",
		"exportpermission" => "permisoexp_hces1",
		"urlfriendly" => "webfriend_hces1",
		"order" => "orden_hces1",
		"maxbid" => "implic_hces1",
		"infoforauctioner" => "infotr_hces1",
		"owner" => "prop_hces1",
		"imgfriendly" => "imgfriendly_hces1",
		"metatitle" => "webmetat_hces1",
		"metadescription" => "webmetad_hces1",
		"withstock" => "controlstock_hces1",
		"stock" => "stock_hces1",
		"transport" => "transport_hces1",
		"other_id" => "loteaparte_hces1",
		"note" => "obsdet_hces1",
		"idsubsubcategory" => "subfam_hces1"
	];

	protected  $featuresRename = [
		"idfeature" => "idcar_caracteristicas_hces1",
		"num" => "numhces_caracteristicas_hces1",
		"lin" => "linhces_caracteristicas_hces1",
		"idvaluefeature" => "idvalue_caracteristicas_hces1",
		"idfeaturevalue" => "idvalue_caracteristicas_hces1",
		"value" => "value_caracteristicas_hces1",
		"orden" => "orden_caracteristicas_hces1"
	];

	protected  $featuresLangRename = [
		"idfeature" => "idcar_car_hces1_lang",
		"num" => "numhces_car_hces1_lang",
		"lin" => "linhces_car_hces1_lang",
		"value" => "value_car_hces1_lang",
		"lang" => "lang_car_hces1_lang"
	];

	protected  $hces1LangRename = [
		"lang" => "lang_hces1_lang",
		"num" => "num_hces1_lang",
		"lin" => "lin_hces1_lang",
		"title" => "descweb_hces1_lang",
		"description" => "desc_hces1_lang",
		"extrainfo" => "descdet_hces1_lang",
		"search" => "search_hces1_lang",
		"urlfriendly" => "webfriend_hces1_lang",
		"metatitle" => "webmetat_hces1_lang",
		"metadescription" => "webmetad_hces1_lang"
	];

	protected  $featuresRules = [
		'idfeature' => "filled|numeric|max:9999999",
		"idvaluefeature" => "numeric|nullable",
		"idfeaturevalue" => "numeric|nullable",
		"value" => "nullable"
	];
	protected  $rules = [
