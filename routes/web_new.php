...
Route::post('/accept_cookies', [HomeController::class, 'accept_cookies']);  // Función para aceptar las cookies legales

/* Route::controller(HomeController::class)->group(function () {
    Route::get(\Routing::is_home(), 'index')->name('home');
    Route::post('/accept_cookies', 'accept_cookies');  // Función para aceptar las cookies legales
}); */

Route::get('prueba', [Prueba::class, 'index'])->name('prueba');
...
Route::get('/generate_images', [Prueba::class, 'generate_images']);

Route::get('/{lang?}/module/labelsubastas/obtenersubasta', [HomeController::class, 'obtenersubasta']);
...
Route::get(\Routing::slugSeo('usuario-registrado'), [UserController::class, 'SuccessRegistered']);
Route::post(\Routing::slug('login'), [UserController::class, 'login_post']);
Route::post('/login_post_ajax', [UserController::class, 'login_post_ajax']);
Route::post(\Routing::slug('registro'), [UserController::class, 'registro']);
...
Route::get(\Routing::slugSeo('subastas') . "-{keycategory}", [LotListController::class, 'getLotsListCategory'])->name('category');
