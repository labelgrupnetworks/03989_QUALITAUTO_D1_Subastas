!function() {
    var t = sessionStorage.getItem("__LAHOME_CONFIG__");
    ...
    config.theme = e.getAttribute("data-bs-theme") || o.theme;
    config.topbar.color = e.getAttribute("data-topbar-color") || o.topbar.color;
    config.menu.color = e.getAttribute("data-menu-color") || o.menu.color;
    config.menu.size = e.getAttribute("data-menu-size") || o.menu.size;
    ...
    if (config) {
        ...
        if (window.innerWidth <= 1199) {
            e.setAttribute("data-menu-size", "hidden");
        } else {
            e.setAttribute("data-menu-size", config.menu.size);
        }
    }
}();
