 ...
 */
 ...
 /*
                   ...
                   if (typeof cod_licit == 'undefined' || cod_licit == null )
                    {
                        ...
                        if (!auction_info.user.is_gestor && (parseInt($("#bid_amount").val()) < parseInt(auction_info.lote_actual.importe_escalado_siguiente)) )
                        {
   ...
   function actionResponseDesign_O(data){
       ...
       $('#actual_max_bid').html(data.formatted_actual_bid + " €");
       if(currency !== null ){
            value_currecy = calculate_currency(data)
            $('#actual_max_bid_'+currency.cod_div).html(value_currecy);
        }
...
/*
    ...
    */
     ...
     function displayAlert_O(type, msg)
	{
        ...
        function calculate_currency(data){
            return parseFloat(data.formatted_actual_bid * currency.impd_div).toFixed(0) +' '+ currency.symbolhtml_div
        }
	/*
    |--------------------------------------------------------------------------
    | END Mostrar alertas 
