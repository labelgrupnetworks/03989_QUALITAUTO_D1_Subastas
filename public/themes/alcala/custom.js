...
$('#button-open-user-menu').click(function() {
   ...
   //verifica si las password son identicas
    ...
    $('#newsletter-btn').on('click', function () {
        ...
        response2 = $("#g-recaptcha-response-1").val(); // Esto está para cuando existen 2 repatchas. Ej: Contactar

        if (!response && !response2) {
            error = true;
            message = message + messages.error.recaptcha_incorrect + ". ";
        }
