	...
	$('.closedd').on('click', function(){
	  ...
	  $('.login_desktop').fadeToggle("fast");
        ...
        $('#newsletter-btn').on('click',function() {
            ...
            var accept_new_condiciones = false;
             var accept_new = false;

            if($('#accept_new_condiciones').prop( "checked" )){
                    accept_new_condiciones = true;
            }

            if($('#accept_new').prop( "checked" )){
                    accept_new = true;
            }

            if(accept_new_condiciones && accept_new){
                    $.ajax({
                    type: "POST",
