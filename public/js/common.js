		...
		if($('#bid_amount').hasClass("NoAutoComplete_JS") == false){
			...
			$('#bid_amount').autoComplete({
				...
				source: function (term, response) {
					...
					$.getJSON('/api-ajax/calculate_bids/' + auction_info.lote_actual.importe_escalado_siguiente + '/' + term + '?cod_sub=' + auction_info.subasta.cod_sub + '&inversa=' +  auction_info.lote_actual.inversa_sub, function (data) {
						var matches = [];
